...
.ornaments:
	...
	db DECO_CHIKORITA_DOLL ; 30
	db DECO_CYNDAQUIL_DOLL ; 31
	db DECO_TOTODILE_DOLL ; 32
	db DECO_MAREEP_DOLL ; 33
	db DECO_TEDDIURSA_DOLL ; 34
	db DECO_EEVEE_DOLL ; 35
	db DECO_RAICHU_DOLL ; 36
	db -1
