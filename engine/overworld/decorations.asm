...
.ornaments:
	...
	db DECO_DIGLETT_DOLL ; 25
	db DECO_MAGIKARP_DOLL ; 26
	db DECO_ODDISH_DOLL ; 27
	db DECO_GENGAR_DOLL ; 28
	db DECO_SHELLDER_DOLL ; 29
	db DECO_GRIMER_DOLL ; 2a
	db DECO_VOLTORB_DOLL ; 2b
	db DECO_SNUBBULL_DOLL ; 2c
	db DECO_TENTACOOL_DOLL ; 2d
	db DECO_GOLD_TROPHY_DOLL ; 2e
	db DECO_SILVER_TROPHY_DOLL ; 2f
	db DECO_CRYSTAL_TROPHY_DOLL ; 30
	db DECO_CHIKORITA_DOLL ; 31
	db DECO_CYNDAQUIL_DOLL ; 32
	db DECO_TOTODILE_DOLL ; 33
	db DECO_MAREEP_DOLL ; 34
	db DECO_TEDDIURSA_DOLL ; 35
	db DECO_EEVEE_DOLL ; 36
	db DECO_RAICHU_DOLL ; 37
	db -1
