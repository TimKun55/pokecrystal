...
BlindingFlash:
	...
	farcall FadeInFromWhite_EnableDynNoApply
	ret
...
HideHeadbuttTree:
	; Replaces all four headbutted tree tiles with tile $04
	; Assumes any tileset with headbutt trees has grass at tile $04
	xor a
	ldh [hBGMapMode], a
