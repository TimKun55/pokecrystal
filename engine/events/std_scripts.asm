...
StdScripts::
	...
	add_stdscript VendingMachineScript
...
RadioTowerRocketsScript:
	...
	setevent EVENT_MAHOGANY_TOWN_HIKER_BLOCKS_EAST
...
InitializeEventsScript:
	...
	setevent EVENT_FAST_SHIP_B1F_SAILOR_GENERATOR_ROOM
	...
	setevent EVENT_RUINS_OF_ALPH_OUTSIDE_TOURIST_HIKER
	...
	variablesprite SPRITE_FAKE_DIRECTOR, SPRITE_GENTLEMAN
	...
	setevent EVENT_GS_BALL_CHAMBER_BALL_RELIC
	...
	setevent EVENT_GOLDENROD_BIKE_SHOP_CUSTOMERS
	setevent EVENT_GIOVANNI_AT_HOME
	setevent EVENT_SEAFOAM_GYM_MAGMORTAR
	setevent EVENT_SAW_RAIKOU_ON_ROUTE_38
	setevent EVENT_SAW_RAIKOU_ON_ROUTE_44
	setevent EVENT_SAW_RAIKOU_ON_ROUTE_43
	setevent EVENT_LAKE_OF_RAGE_RAIKOU
	setevent EVENT_SAW_ENTEI_ON_ROUTE_37
	setevent EVENT_SAW_ENTEI_ON_ROUTE_30
	setevent EVENT_BURNED_TOWER_B1F_ENTEI
	setevent EVENT_MOUNT_MOON_B2F_OLD_AMBER
	setevent EVENT_MOUNT_MOON_B2F_DOME_FOSSIL
	setevent EVENT_MOUNT_MOON_B2F_HELIX_FOSSIL
	setevent EVENT_RUINS_OF_ALPH_OUTSIDE_FOSSIL_SCIENTIST
	setevent EVENT_RUINS_OF_ALPH_RESEARCH_CENTER_FOSSIL_SCIENTIST
	setevent EVENT_POWER_PLANT_ELECTRICITY
	setevent EVENT_OLIVINE_MARKET_CLERK_1
	setevent EVENT_OLIVINE_MARKET_CLERK_2
	setevent EVENT_OLIVINE_MARKET_CLERK_3
	setevent EVENT_BATTLE_HALL_1F_INVER
	setevent EVENT_BATTLE_HALL_BATTLE_ROOM_INVER
	setevent EVENT_PLAYERS_HOUSE_1F_SILVER_TROPHY
	setevent EVENT_PLAYERS_HOUSE_1F_GOLD_TROPHY
	setevent EVENT_PLAYERS_HOUSE_1F_CRYSTAL_TROPHY
	setevent EVENT_ICE_PATH_1F_LANCE
	setevent EVENT_VERMILION_SAILORS_HOUSE_SAILOR
	setevent EVENT_BATTLE_HALL_INVERSE_MODE
	setevent EVENT_BATTLE_HALL_1F_THORTON
	setevent EVENT_BATTLE_HALL_BATTLE_ROOM_THORTON
	setevent EVENT_VERMILION_SAILORS_HOUSE_SCIENTIST
