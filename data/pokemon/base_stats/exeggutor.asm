	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, ROLLOUT, TOXIC, PSYCH_UP, HIDDEN_POWER, SNORE, HYPER_BEAM, PROTECT, GIGA_DRAIN, ENDURE, SOLARBEAM, RETURN, PSYCHIC_M, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SLUDGE_BOMB, DREAM_EATER, REST, ATTRACT, THIEF, MEGA_DRAIN, BODY_SLAM, SLUDGE, BULLDOZE, NIGHTMARE, STRENGTH, FLASH, ENERGY_BALL, ZEN_HEADBUTT, GIGA_IMPACT, SUNNY_DAY
	; end
