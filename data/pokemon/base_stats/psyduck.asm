	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, TOXIC, ROCK_SMASH, PSYCH_UP, HIDDEN_POWER, SNORE, BLIZZARD, ICY_WIND, PROTECT, RAIN_DANCE, ENDURE, IRON_TAIL, RETURN, DIG, MUD_SLAP, DOUBLE_TEAM, ICE_PUNCH, SWAGGER, SLEEP_TALK, SWIFT, REST, ATTRACT, HAIL, SURF, STRENGTH, FLASH, WHIRLPOOL, WATERFALL, ICE_BEAM, SIGNAL_BEAM, GROWTH_PUNCH, WATER_PULSE, ZEN_HEADBUTT
	; end
