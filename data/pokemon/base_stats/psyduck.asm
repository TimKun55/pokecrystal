	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, TOXIC, ROCK_SMASH, CALM_MIND, HIDDEN_POWER, SNORE, BLIZZARD, ICY_WIND, PROTECT, SCALD, ENDURE, IRON_TAIL, RETURN, DIG, MUD_SLAP, DOUBLE_TEAM, ICE_PUNCH, SWAGGER, SLEEP_TALK, AERIAL_ACE, SWIFT, REST, ATTRACT, HAIL, SURF, STRENGTH, FLASH, WHIRLPOOL, WATERFALL, ICE_BEAM, SIGNAL_BEAM, GROWTH_PUNCH, WATER_PULSE, ZEN_HEADBUTT, AQUA_TAIL, RAIN_DANCE
	; end
