	...
	; tm/hm learnset
	tmhm HEADBUTT, CURSE, TOXIC, ZAP_CANNON, PSYCH_UP, HIDDEN_POWER, SNORE, BLIZZARD, ICY_WIND, PROTECT, SCALD, ENDURE, IRON_TAIL, EARTHQUAKE, RETURN, DIG, PSYCHIC_M, SHADOW_BALL, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, FIRE_BLAST, SWIFT, DREAM_EATER, REST, ATTRACT, NIGHTMARE, BULLDOZE, HAIL, SURF, STRENGTH, FLASH, FLAMETHROWER, ICE_BEAM, SIGNAL_BEAM, WATER_PULSE, ZEN_HEADBUTT, SUNNY_DAY, RAIN_DANCE
	; end
