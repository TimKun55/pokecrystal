	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, ROLLOUT, TOXIC, ZAP_CANNON, PSYCH_UP, HIDDEN_POWER, SUNNY_DAY, SNORE, BLIZZARD, PROTECT, RAIN_DANCE, ENDURE, SOLARBEAM, IRON_TAIL, THUNDER, RETURN, PSYCHIC_M, SHADOW_BALL, MUD_SLAP, DOUBLE_TEAM, ICE_PUNCH, SWAGGER, SLEEP_TALK, FIRE_BLAST, DEFENSE_CURL, THUNDERPUNCH, DREAM_EATER, REST, ATTRACT, FIRE_PUNCH, NIGHTMARE, CHARGE_BEAM, STRENGTH, FLASH, FLAMETHROWER, THUNDERBOLT, ICE_BEAM, DISARM_VOICE, DRAIN_KISS, DAZZLINGLEAM, MOONBLAST , DRAIN_PUNCH, SIGNAL_BEAM, GROWTH_PUNCH, WATER_PULSE, ZEN_HEADBUTT, PLAY_ROUGH
	; end
