	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, ROLLOUT, TOXIC, ROCK_SMASH, HIDDEN_POWER, SNORE, BLIZZARD, ICY_WIND, PROTECT, SCALD, ENDURE, ROCK_TOMB, IRON_TAIL, RETURN, DIG, MUD_SLAP, DOUBLE_TEAM, ICE_PUNCH, SWAGGER, SLEEP_TALK, DEFENSE_CURL, REST, ATTRACT, HAIL, SURF, STRENGTH, WHIRLPOOL, WATERFALL, ICE_BEAM, GROWTH_PUNCH, ZEN_HEADBUTT, ROCK_TOMB, IRON_DEFENSE, AQUA_TAIL, RAIN_DANCE
	; end
