	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, ROLLOUT, ROAR, TOXIC, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, SNORE, HYPER_BEAM, PROTECT, ENDURE, ROCK_TOMB, EARTHQUAKE, RETURN, DIG, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SANDSTORM, FIRE_BLAST, DEFENSE_CURL, REST, ATTRACT, FIRE_PUNCH, FURY_CUTTER, BODY_SLAM, BULLDOZE, STRENGTH, FLAMETHROWER, STONE_EDGE, ROCK_BLAST, FOCUS_BLAST, GROWTH_PUNCH, SAND_TOMB, ROCK_TOMB, GIGA_IMPACT
	; end
