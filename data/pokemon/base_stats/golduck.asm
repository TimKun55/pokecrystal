	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, TOXIC, ROCK_SMASH, PSYCH_UP, HIDDEN_POWER, SNORE, BLIZZARD, HYPER_BEAM, ICY_WIND, PROTECT, RAIN_DANCE, ENDURE, IRON_TAIL, RETURN, DIG, MUD_SLAP, DOUBLE_TEAM, ICE_PUNCH, SWAGGER, SLEEP_TALK, SWIFT, REST, ATTRACT, FURY_CUTTER, BODY_SLAM, HAIL, SURF, STRENGTH, FLASH, WHIRLPOOL, WATERFALL, ICE_BEAM, SIGNAL_BEAM, FOCUS_BLAST, GROWTH_PUNCH, WATER_PULSE, GIGA_IMPACT
	; end
