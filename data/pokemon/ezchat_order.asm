...
.to_do:    db DODUO, DODRIO, SMEARGLE, KOFFING, TENTACRUEL, TOGEKISS, TOGETIC, TOGEPI, GOLDEEN, METAPOD, HONCHKROW, DONPHAN, -1
...
.ma:       db MAGCARGO, SLUGMA, QUILAVA, BELLSPROUT, WEEZING, MARILL, AZUMARILL, ELECTRODE, MANKEY, MANTINE, MAMOSWINE, -1
