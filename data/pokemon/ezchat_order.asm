...
.a:        db EKANS, ARBOK, ARIADOS, CROCONAW, UNOWN, -1
.i:        db EEVEE, GEODUDE, SPINARAK, PILOSWINE, ONIX, -1
.u:        db ARCANINE, SUDOWOODO, WEEPINBELL, VICTREEBEL, WOOPER, SWINUB, -1
.e:        db SKARMORY, ESPEON, HITMONCHAN, ELECTIVIRE, ELECTABUZZ, ENTEI, -1
.o:        db FERALIGATR, FURRET, OCTILLERY, PRIMEAPE, SENTRET, OMASTAR, OMANYTE, -1
...
.ku_gu:    db GLOOM, PINECO, GLISCOR, GLIGAR, KRABBY, GRANBULL, CROBAT, -1
...
.shi_ji:   db SEADRA, SHELLDER, VAPOREON, MAGNEZONE, DEWGONG, -1
...
.to_do:    db DODUO, DODRIO, SMEARGLE, KOFFING, TENTACRUEL, TOGEKISS, TOGETIC, TOGEPI, METAPOD, HONCHKROW, RHYPERIOR, DONPHAN, -1
.na:       db ODDISH, EXEGGUTOR, -1
.ni:       db NIDOKING, NIDOQUEEN, NIDORAN_M, NIDORAN_F, NIDORINA, NIDORINO, SYLVEON, MEOWTH, SNEASEL, POLIWHIRL, POLITOED, POLIWRATH, POLIWAG, -1
.nu:       db QUAGSIRE, -1
.ne:       db NATU, XATU, -1
.no:       db DUNSPARCE, -1
...
.fu_bu_pu: db MOLTRES, FLAREON, ALAKAZAM, MAGMAR, MAGMORTAR, FORRETRESS, WIGGLYTUFF, IVYSAUR, BULBASAUR, VENUSAUR, AERODACTYL, UMBREON, ARTICUNO, JIGGLYPUFF, SNUBBULL, -1
.he_be_pe: db BAYLEEF, GRIMER, MUK, HERACROSS, HOUNDOOM, PERSIAN, -1
.ho_bo_po: db HO_OH, HOOTHOOT, PIDGEY, PONYTA, SKIPLOOM, PORYGON, PORYGON_Z, PORYGON2, -1
.ma:       db MAGCARGO, SLUGMA, QUILAVA, BELLSPROUT, WEEZING, MARILL, AZUMARILL, ELECTRODE, WEAVILE, MANKEY, MANTINE, MAMOSWINE, -1
.mi:       db DRATINI, MEW, MEWTWO, MILTANK, -1
.mu:       db MISDREAVUS, MISMAGIUS, -1
.me:       db MEGANIUM, YANMEGA, DITTO, TENTACOOL, MAREEP, -1
.mo:       db FLAAFFY, VENOMOTH, TANGROWTH, TANGELA, -1
