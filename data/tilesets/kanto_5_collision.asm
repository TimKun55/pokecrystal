	...
	tilecoll TALL_GRASS, FLOOR, TALL_GRASS, FLOOR ; c6
	tilecoll FLOOR, TALL_GRASS, FLOOR, TALL_GRASS ; c7
	...
	tilecoll WATER, WATER, WALL, WALL ; de
	tilecoll WATER, WATER, WALL, WALL ; df
