	...
	tilecoll FLOOR, MART_SHELF, FLOOR, MART_SHELF ; 22
	...
	tilecoll MART_SHELF, FLOOR, FLOOR, LADDER ; 67
	tilecoll WALL, FLOOR, WALL, COUNTER ; 68
	tilecoll WALL, WALL, COUNTER, WALL ; 69
