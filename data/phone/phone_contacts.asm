...
; entries correspond to PHONE_* constants
	...
	phone TRAINER_NONE, PHONECONTACT_MUM,      PLAYERS_HOUSE_1F,          ANYTIME, MumPhoneCalleeScript,     0,       UnusedPhoneScript
	...
	phone TRAINER_NONE, PHONECONTACT_LYRA,     N_A,                       ANYTIME, LyraPhoneCalleeScript,    ANYTIME, LyraPhoneCallerScript
