...
; BATTLE_ANIM_OBJ_SPIKES
	battleanimobj RELATIVE_X | X_FLIP, $78, BATTLE_ANIM_FRAMESET_SPIKE, BATTLE_ANIM_FUNC_SPIKES, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_MISC
...
; BATTLE_ANIM_OBJ_BUBBLE_SPLASH
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLE_ANIM_FRAMESET_BUBBLE_SPLASH, BATTLE_ANIM_FUNC_ICE_SPLASH, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_BUBBLE
