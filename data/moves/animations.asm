...
BattleAnim_ThrowPokeBall:
	...
	; any other ball
	anim_4gfx BATTLE_ANIM_GFX_POKE_BALL, BATTLE_ANIM_GFX_POKE_BALL_BG, BATTLE_ANIM_GFX_SMOKE, BATTLE_ANIM_GFX_OBJECTS
	anim_sound 6, 2, SFX_THROW_BALL
	anim_obj BATTLE_ANIM_OBJ_POKE_BALL, 68, 92, $30
	anim_obj BATTLE_ANIM_OBJ_POKE_BALL_BG, 68, 92, $30
	anim_wait 36
...
.MasterBall:
	anim_5gfx BATTLE_ANIM_GFX_POKE_BALL, BATTLE_ANIM_GFX_POKE_BALL_BG, BATTLE_ANIM_GFX_SMOKE, BATTLE_ANIM_GFX_SPEED, BATTLE_ANIM_GFX_OBJECTS
	anim_sound 6, 2, SFX_THROW_BALL
	anim_obj BATTLE_ANIM_OBJ_POKE_BALL, 68, 92, $30
	anim_obj BATTLE_ANIM_OBJ_POKE_BALL_BG, 68, 92, $30
	anim_wait 36
...
BattleAnim_EnergyBall:
	...
	anim_sound 6, 2, SFX_THROW_BALL
	anim_obj BATTLE_ANIM_OBJ_ENERGY_BALL, 64, 92, $10
	anim_wait 36
...
BattleAnim_DrainPunch:
	...
	anim_wait 20
	anim_call BattleAnim_Absorb.AbsorbStart
...
BattleAnim_DoubleKick:
	...
	anim_jump BattleAnim_TripleKick.start
...
.loop
	anim_sound 6, 2, SFX_EMBER
	anim_obj BATTLE_ANIM_OBJ_FIRE_SPIN, 132, 66, $30
	anim_wait 2
	anim_sound 6, 2, SFX_EMBER
	anim_obj BATTLE_ANIM_OBJ_FIRE_SPIN, 132, 66, $20
	anim_wait 2
	anim_sound 6, 2, SFX_EMBER
	anim_obj BATTLE_ANIM_OBJ_FIRE_SPIN, 136, 70, $10
	anim_wait 2
	anim_sound 6, 2, SFX_EMBER
	anim_obj BATTLE_ANIM_OBJ_FIRE_SPIN, 128, 70, $0
	anim_wait 4
	anim_loop 3, .loop
	anim_wait 48
	anim_ret
...
BattleAnim_Scald:
	...
	anim_1gfx BATTLE_ANIM_GFX_WATER_BALL
	anim_bgeffect BATTLE_BG_EFFECT_CYCLE_OBPALS_GRAY_AND_YELLOW, $0, $2, $0
...
.loop
	...
	anim_wait 5
	anim_obj BATTLE_ANIM_OBJ_GLIMMER, 112, 68, $0
	anim_wait 5
	anim_obj BATTLE_ANIM_OBJ_GLIMMER, 154, 36, $0
	anim_wait 5
	anim_obj BATTLE_ANIM_OBJ_GLIMMER, 136, 80, $0
	anim_wait 5
	anim_obj BATTLE_ANIM_OBJ_GLIMMER, 124, 24, $0
	anim_wait 5
	anim_loop 2, .loop
	anim_wait 32
	anim_setobjpal PAL_BATTLE_OB_GRAY, PAL_BTLCUSTOM_GRAY
...
.loop
	...
	anim_obj BATTLE_ANIM_OBJ_GUNK_SHOT, 64, 88, $6
	anim_wait 1
	anim_obj BATTLE_ANIM_OBJ_GUNK_SHOT, 64, 88, $6
	anim_wait 1
	anim_loop 14, .loop
...
BattleAnim_Explosion:
	...
	anim_jump BattleAnimSub_Explosion2
...
BattleAnim_Scratch:
	...
	anim_jump BattleAnim_ScratchStub
...
BattleAnim_Acrobatics:
	...
	anim_obj BATTLE_ANIM_OBJ_HIT_YFIX, -14, 0,   8, 0, $0
	anim_wait 6
	anim_sound 0, 1, SFX_COMET_PUNCH
	anim_obj BATTLE_ANIM_OBJ_HIT_YFIX, -15, 0,   7, 0, $0
	anim_wait 6
	anim_sound 0, 1, SFX_COMET_PUNCH
	anim_obj BATTLE_ANIM_OBJ_HIT_YFIX, -14, 0,   6, 0, $0
	anim_wait 6
	anim_sound 0, 1, SFX_COMET_PUNCH
	anim_obj BATTLE_ANIM_OBJ_HIT_YFIX, -15, 0,   5, 0, $0
	anim_wait 6
	anim_sound 0, 1, SFX_COMET_PUNCH
	anim_obj BATTLE_ANIM_OBJ_HIT_YFIX, -14, 0,   4, 0, $0
	anim_wait 6
	anim_sound 0, 1, SFX_COMET_PUNCH
	anim_obj BATTLE_ANIM_OBJ_HIT_YFIX, -15, 0,   3, 0, $0
	anim_wait 6
	anim_bgeffect BATTLE_BG_EFFECT_SHOW_MON, $0, BG_EFFECT_USER, $0
	anim_wait 16
	anim_ret
...
BattleAnim_FreshSnack:
	anim_2gfx BATTLE_ANIM_GFX_OBJECTS, BATTLE_ANIM_GFX_BUBBLE
	anim_call BattleAnim_TargetObj_1Row
	anim_obj BATTLE_ANIM_OBJ_CAKE, 74, 104, $0
	anim_wait 16
	anim_bgeffect BATTLE_BG_EFFECT_FADE_MON_TO_LIGHT_REPEATING, $0, BG_EFFECT_USER, $40
...
.loop
	anim_sound 0, 0, SFX_SWORDS_DANCE
	anim_call BattleAnim_FocusEnergyStub
	anim_loop 3, .loop
	anim_wait 8
	anim_incbgeffect BATTLE_BG_EFFECT_FADE_MON_TO_LIGHT
	anim_ret

BattleAnim_FocusEnergyStub:
...
BattleAnim_SandTomb:
	...
	anim_3gfx BATTLE_ANIM_GFX_SAND, BATTLE_ANIM_GFX_WIND, BATTLE_ANIM_GFX_HIT
	anim_call BattleAnim_SandAttack.loop
	anim_setobjpal PAL_BATTLE_OB_GRAY, PAL_BTLCUSTOM_BROWN
	anim_call BattleAnim_Gust.loop
	anim_setobjpal PAL_BATTLE_OB_GRAY, PAL_BTLCUSTOM_GRAY
	anim_ret
...
BattleAnim_Reflect:
	anim_setobjpal PAL_BATTLE_OB_YELLOW, PAL_BTLCUSTOM_REFLECT
...
BattleAnim_FocusBlast:
	anim_2gfx BATTLE_ANIM_GFX_SPEED, BATTLE_ANIM_GFX_FOCUS_BLAST
	anim_call BattleAnim_TargetObj_1Row
	anim_call BattleAnim_FocusEnergy
	anim_call BattleAnim_ShowMon_0
	anim_obj BATTLE_ANIM_OBJ_FOCUS_BLAST, 64, 88, $6
	anim_wait 12
...
BattleAnim_ChargeBeam:
	anim_2gfx BATTLE_ANIM_GFX_BEAM, BATTLE_ANIM_GFX_LIGHTNING
	anim_bgeffect BATTLE_BG_EFFECT_FLASH_INVERTED, $0, $4, $2
	anim_bgeffect BATTLE_BG_EFFECT_ALTERNATE_HUES, $0, $2, $0
	anim_wait 48
	anim_call BattleAnimSub_Beam
...
BattleAnim_DrainKiss:
	anim_3gfx BATTLE_ANIM_GFX_OBJECTS, BATTLE_ANIM_GFX_ANGELS, BATTLE_ANIM_GFX_CHARGE
...
.loop
	anim_bgeffect BATTLE_BG_EFFECT_VIBRATE_MON, $0, $0, $0
	anim_sound 0, 1, SFX_BITE
	anim_obj BATTLE_ANIM_OBJ_HIT_SMALL_YFIX, 140, 44, $0
	anim_obj BATTLE_ANIM_OBJ_ROCK_SMASH, 136, 56, $5c
	anim_wait 4
	anim_sound 0, 1, SFX_BITE
	anim_obj BATTLE_ANIM_OBJ_HIT_SMALL_YFIX, 124, 60, $0
	anim_obj BATTLE_ANIM_OBJ_ROCK_SMASH, 136, 56, $d0
	anim_wait 4
	anim_sound 0, 1, SFX_BITE
	anim_obj BATTLE_ANIM_OBJ_HIT_SMALL_YFIX, 140, 60, $0
	anim_obj BATTLE_ANIM_OBJ_ROCK_SMASH, 136, 56, $e8
	anim_wait 4
	anim_sound 0, 1, SFX_BITE
	anim_obj BATTLE_ANIM_OBJ_HIT_SMALL_YFIX, 124, 44, $0
...
BattleAnim_Agility:
	...
	anim_obp0 $fc
	anim_bgeffect BATTLE_BG_EFFECT_FADE_MON_TO_LIGHT_REPEATING, $0, BG_EFFECT_USER, $40
	anim_call BattleAnim_AgilityStub
.loop
	anim_sound 0, 0, SFX_RAZOR_WIND
	anim_wait 4
	anim_loop 18, .loop
...
BattleAnim_ZapCannon:
	anim_2gfx BATTLE_ANIM_GFX_LIGHTNING, BATTLE_ANIM_GFX_EXPLOSION
	anim_setobjpal PAL_BATTLE_OB_GRAY, PAL_BTLCUSTOM_LIGHTSCREEN
...
.loop
	anim_sound 6, 2, SFX_SHINE
	anim_obj BATTLE_ANIM_OBJ_BLIZZARD, 64, 88, $4
	anim_wait 2
	anim_sound 6, 2, SFX_SHINE
	anim_obj BATTLE_ANIM_OBJ_BLIZZARD, 64, 96, $3
	anim_wait 2
	anim_sound 6, 2, SFX_SHINE
	anim_obj BATTLE_ANIM_OBJ_BLIZZARD, 64, 88, $3
	anim_wait 2
	anim_sound 6, 2, SFX_SHINE
	anim_obj BATTLE_ANIM_OBJ_BLIZZARD, 64, 96, $4
	anim_wait 2
	anim_loop 2, .loop
	anim_call BattleAnimSub_Ice
	anim_wait 16
...
.loop
	anim_sound 6, 2, SFX_EMBER
	anim_obj BATTLE_ANIM_OBJ_HEAT_WAVE, 64, 88, $4
	anim_wait 2
	anim_sound 6, 2, SFX_EMBER
	anim_obj BATTLE_ANIM_OBJ_HEAT_WAVE, 64, 96, $3
	anim_wait 2
	anim_sound 6, 2, SFX_EMBER
	anim_obj BATTLE_ANIM_OBJ_HEAT_WAVE, 64, 88, $3
	anim_wait 2
	anim_sound 6, 2, SFX_EMBER
	anim_obj BATTLE_ANIM_OBJ_HEAT_WAVE, 64, 96, $4
	anim_wait 2
	anim_loop 3, .loop
	anim_wait 48
	anim_incbgeffect BATTLE_BG_EFFECT_WHIRLPOOL
...
BattleAnim_SweetScent2: ; both animations are practically the same
