...
KantoGrassWildMons:
	...
	; morn
	;   %, species,		 min, max
	db 22, PARASECT,      55,  58
	db 22, GOLEM,         55,  58
	db 22, SANDSLASH,     55,  58
	db 10, CROBAT,        55,  58
	db  8, PARASECT,      55,  58
	db  8, GOLEM,         55,  58
	db  8, CLEFABLE,      55,  58
	...
	db 22, PARASECT,      60,  63
	db 22, CROBAT,        60,  63
	db 22, WOBBUFFET,     60,  63
	db 10, MACHAMP,       60,  63
	db  8, MAGNEZONE,     60,  63
	db  8, ALAKAZAM,      60,  63
	db  8, DITTO,         60,  63
	; day
	;   %, species,		 min, max
	...
	; morn
	;   %, species,		 min, max
	db 22, RATICATE,      53,  55
	db 22, RATICATE,      56,  58
	db 22, MAGNETON,      56,  58
	db 10, DROWZEE,       50,  52
	db  8, HYPNO,         56,  58
	db  8, HERACROSS,     56,  58
	db  8, HERACROSS,     56,  58
	; day
	;   %, species,		 min, max
	db 22, RATICATE,      53,  55
	...
	; morn
	;   %, species,		 min, max
	db 22, BEEDRILL,      53,  55
	db 22, BEEDRILL,      53,  55
	db 22, BUTTERFREE,    53,  55
	db 10, BUTTERFREE,    53,  55
	db  8, KADABRA,       48,  50
	db  8, SUNFLORA,      53,  55
	db  8, VICTREEBEL,    53,  55
	; day
	;   %, species,		 min, max
	db 22, BEEDRILL,      53,  55
	db 22, BEEDRILL,      53,  55
	...
	db 22, BUTTERFREE,    53,  55
	db 22, BUTTERFREE,    53,  55
	db 22, VENOMOTH,      53,  55
	db 10, BEEDRILL,      53,  55
	db  8, VILEPLUME,     53,  55
	db  8, BEEDRILL,      53,  55
	db  8, VENOMOTH,      53,  55
	end_grass_wildmons
	...
	db 19, ARBOK,         33,  36
	db  5, IVYSAUR,       23,  26
	db  5, CHARMELEON,    23,  26
	db  5, WARTORTLE,     23,  26
	; nite
	;   %, species,		 min, max
	db 22, DODRIO,        33,  36
	db 22, SANDSLASH,     33,  36
	...
	db 19, ARBOK,         33,  36
	db  5, VENUSAUR,      33,  36
	db  5, CHARIZARD,     33,  36
	db  5, BLASTOISE,     33,  36
	end_grass_wildmons
	...
	db 23, NIDOQUEEN,     58,  60
	db 23, NIDOKING,      58,  60
	db 10, RHYDON,        58,  60
	db  8, SCYTHER,       58,  60
	db  8, PINSIR,        58,  60
	db  5, BLISSEY,       50,  51
	...
	db 22, PARASECT,      58,  60
	db 22, VENOMOTH,      58,  60
