...
ENDM
	...
	connection south, Route32, ROUTE_32, 3
	...
	connection north, VioletCity, VIOLET_CITY, -3
	...
	map_attributes SlowpokeWellEntrance, SLOWPOKE_WELL_ENTRANCE, $8d, 0
	...
	map_attributes EarlsPokemonAcademyB1F, EARLS_POKEMON_ACADEMY_B1F, $00, 0
...
;	map_attributes TimeCapsule, TIME_CAPSULE, $00, 0
	...
	map_attributes Route18EastWestGate, ROUTE_18_EAST_WEST_GATE, $00, 0
	map_attributes ManiasHouse, MANIAS_HOUSE, $00, 0
	map_attributes CianwoodGym, CIANWOOD_GYM, $db, 0
	...
	map_attributes PokemonLeagueGate, POKEMON_LEAGUE_GATE, $00, 0
