...
ENDM
	...
	map_attributes CherrygroveCity, CHERRYGROVE_CITY, $05
	...
	map_attributes OlivineCity, OLIVINE_CITY, $25
	...
	map_attributes BlackthornCity, BLACKTHORN_CITY, $45
	connection south, Route45, ROUTE_45, 0
	connection west, Route44, ROUTE_44, 9

	map_attributes MtSilverOutside, MT_SILVER_OUTSIDE, $45
	...
	map_attributes Route28, ROUTE_28, $45
	...
	connection west, VioletCity, VIOLET_CITY, -12
	...
	map_attributes BurnedTowerB1F, BURNED_TOWER_B1F, $bd
	map_attributes NationalPark, NATIONAL_PARK, $45
	map_attributes NationalParkBugContest, NATIONAL_PARK_BUG_CONTEST, $45
	...
	map_attributes RuinsOfAlphGSBallChamber, RUINS_OF_ALPH_GS_BALL_CHAMBER, $00
	map_attributes RuinsOfAlphCaveEntrance, RUINS_OF_ALPH_CAVE_ENTRANCE, $00
	map_attributes SlowpokeWellEntrance, SLOWPOKE_WELL_ENTRANCE, $8d
	map_attributes UnionCave1F, UNION_CAVE_1F, $bd
	map_attributes UnionCaveB1F, UNION_CAVE_B1F, $bd
	map_attributes UnionCaveB2F, UNION_CAVE_B2F, $bd
	map_attributes SlowpokeWellB1F, SLOWPOKE_WELL_B1F, $bd
	map_attributes SlowpokeWellB2F, SLOWPOKE_WELL_B2F, $bd
	...
	map_attributes OlivineLighthouseElevator, OLIVINE_LIGHTHOUSE_ELEVATOR, $00
	map_attributes MahoganyMart1F, MAHOGANY_MART_1F, $00
	map_attributes MahoganyMoveTutorHouse, MAHOGANY_MOVE_TUTOR_HOUSE, $00
	...
	map_attributes IlexForest, ILEX_FOREST, $29
	map_attributes GoldenrodUnderground, GOLDENROD_UNDERGROUND, $00
	map_attributes GoldenrodUndergroundEntrances, GOLDENROD_UNDERGROUND_ENTRANCES, $00
	map_attributes GoldenrodUndergroundSwitchRoom, GOLDENROD_UNDERGROUND_SWITCH_ROOM, $00
	...
	map_attributes MountMortar1FOutside, MOUNT_MORTAR_1F_OUTSIDE, $01
	map_attributes MountMortar1FInside, MOUNT_MORTAR_1F_INSIDE, $01
	map_attributes MountMortar2FInside, MOUNT_MORTAR_2F_INSIDE, $01
	map_attributes MountMortarB1F, MOUNT_MORTAR_B1F, $01
	map_attributes IcePath1F, ICE_PATH_1F, $01
	map_attributes IcePathB1F, ICE_PATH_B1F, $01
	map_attributes IcePathB2FMahoganySide, ICE_PATH_B2F_MAHOGANY_SIDE, $01
	map_attributes IcePathB2FBlackthornSide, ICE_PATH_B2F_BLACKTHORN_SIDE, $01
	map_attributes IcePathB3F, ICE_PATH_B3F, $01
	map_attributes WhirlIslandNW, WHIRL_ISLAND_NW, $01
	map_attributes WhirlIslandNE, WHIRL_ISLAND_NE, $01
	map_attributes WhirlIslandSW, WHIRL_ISLAND_SW, $01
	map_attributes WhirlIslandCave, WHIRL_ISLAND_CAVE, $01
	map_attributes WhirlIslandSE, WHIRL_ISLAND_SE, $01
	map_attributes WhirlIslandB1F, WHIRL_ISLAND_B1F, $01
	map_attributes WhirlIslandB2F, WHIRL_ISLAND_B2F, $01
	map_attributes WhirlIslandLugiaChamber, WHIRL_ISLAND_LUGIA_CHAMBER, $0f
	map_attributes MtSilverRoom1, MT_SILVER_ROOM_1, $01
	map_attributes MtSilverRoom2, MT_SILVER_ROOM_2, $bd
	map_attributes MtSilverPeak, MT_SILVER_PEAK, $8d
	map_attributes MtSilverItemRooms, MT_SILVER_ITEM_ROOMS, $bd
	map_attributes DarkCaveVioletEntrance, DARK_CAVE_VIOLET_ENTRANCE, $01
	map_attributes DarkCaveBlackthornEntrance, DARK_CAVE_BLACKTHORN_ENTRANCE, $01
	map_attributes DragonsDen1F, DRAGONS_DEN_1F, $bd
	map_attributes DragonsDenB1F, DRAGONS_DEN_B1F, $45
	map_attributes DragonShrine, DRAGON_SHRINE, $00
	map_attributes TohjoFalls, TOHJO_FALLS, $bd
	...
	map_attributes OlivineMoveTutorHouse, OLIVINE_MOVE_TUTOR_HOUSE, $00
	...
	map_attributes DiglettsCave, DIGLETTS_CAVE, $bd
	map_attributes MountMoon1F, MOUNT_MOON_1F, $bd
	map_attributes MountMoonB1F, MOUNT_MOON_B1F, $bd
	map_attributes MountMoonB2F, MOUNT_MOON_B2F, $bd
	map_attributes UndergroundPath, UNDERGROUND_PATH, $00
	map_attributes RockTunnel1F, ROCK_TUNNEL_1F, $01
	map_attributes RockTunnelB1F, ROCK_TUNNEL_B1F, $01
	map_attributes SafariZoneFuchsiaGate, SAFARI_ZONE_FUCHSIA_GATE, $00
	map_attributes SafariZoneHub, SAFARI_ZONE_HUB, $54
	map_attributes SafariZoneEast, SAFARI_ZONE_EAST, $54
	map_attributes SafariZoneNorth, SAFARI_ZONE_NORTH, $54
	map_attributes SafariZoneWest, SAFARI_ZONE_WEST, $54
	...
	map_attributes VictoryRoad1F, VICTORY_ROAD_1F, $bd
	map_attributes VictoryRoad2F, VICTORY_ROAD_2F, $bd
	map_attributes VictoryRoad3F, VICTORY_ROAD_3F, $bd
	map_attributes CeruleanCave1F, CERULEAN_CAVE_1F, $bd
	map_attributes CeruleanCave2F, CERULEAN_CAVE_2F, $bd
	map_attributes CeruleanCaveB1F, CERULEAN_CAVE_B1F, $bd
	...
	map_attributes EcruteakFairyFamilyHouse, ECRUTEAK_FAIRY_FAMILY_HOUSE, $00
	map_attributes EcruteakSwarmHouse, ECRUTEAK_SWARM_HOUSE, $00
	...
	map_attributes BlackthornMoveTutorHouse, BLACKTHORN_MOVE_TUTOR_HOUSE, $00
	map_attributes MadamItemsHouse, MADAM_ITEMS_HOUSE, $00
	map_attributes CinnabarPokecenter1F, CINNABAR_POKECENTER_1F, $00
	map_attributes CinnabarVolcano1F, CINNABAR_VOLCANO_1F, $bd
	map_attributes CinnabarVolcano2F, CINNABAR_VOLCANO_2F, $bd
	map_attributes CinnabarMoltresNest, CINNABAR_MOLTRES_NEST, $00
	map_attributes SeafoamGym, SEAFOAM_GYM, $bd
	map_attributes SeafoamIslands1F, SEAFOAM_ISLANDS_1F, $bd
	...
	map_attributes CeruleanEmptyHouse, CERULEAN_EMPTY_HOUSE, $00
	map_attributes CeruleanEmptyHouseUnderground, CERULEAN_EMPTY_HOUSE_UNDERGROUND, $00
	...
	map_attributes AzaleaMoveTutorHouse, AZALEA_MOVE_TUTOR_HOUSE, $00
	...
	map_attributes EarlsPokemonAcademyB1F, EARLS_POKEMON_ACADEMY_B1F, $00
	...
	map_attributes VioletPrimosHouse, VIOLET_PRIMOS_HOUSE, $00
	map_attributes VioletMoveTutorHouse, VIOLET_MOVE_TUTOR_HOUSE, $00
	...
	map_attributes Route36VioletGate, ROUTE_36_VIOLET_GATE, $00
	...
	map_attributes GoldenrodFlowerShopGarden, GOLDENROD_FLOWER_SHOP_GARDEN, $45
	map_attributes GoldenrodMoveTutorHouse, GOLDENROD_MOVE_TUTOR_HOUSE, $00
	...
	map_attributes GoldenrodHomeDecoStore1, GOLDENROD_HOME_DECO_STORE_1, $00
	map_attributes GoldenrodHomeDecoStore2, GOLDENROD_HOME_DECO_STORE_2, $00
	map_attributes GoldenrodHomeDecoStore3, GOLDENROD_HOME_DECO_STORE_3, $00
	map_attributes GoldenrodHomeDecoStore4, GOLDENROD_HOME_DECO_STORE_4, $00
	...
	map_attributes VermilionSailorsHouse, VERMILION_SAILORS_HOUSE, $00
	...
	map_attributes Route11Route12Gate, ROUTE_11_ROUTE_12_GATE, $00
	...
	map_attributes Route1ViridianGate, ROUTE_1_VIRIDIAN_GATE, $00
	...
	map_attributes FarawayIslandOutside, FARAWAY_ISLAND_OUTSIDE, $06
	map_attributes FarawayIslandInside, FARAWAY_ISLAND_INSIDE, $17
	...
	map_attributes FuchsiaCinnabarHouse1, FUCHSIA_CINNABAR_HOUSE_1, $00
	...
	map_attributes Route12LavenderGate, ROUTE_12_LAVENDER_GATE, $00
	map_attributes MtSilverPokecenter1F, MT_SILVER_POKECENTER_1F, $00
	...
	map_attributes CeladonHomeDecoStore1F, CELADON_HOME_DECO_STORE_1F, $00
	map_attributes CeladonHomeDecoStoreB1F, CELADON_HOME_DECO_STORE_B1F, $00
	map_attributes CeladonHomeDecoStoreB2F, CELADON_HOME_DECO_STORE_B2F, $00
	map_attributes CeladonCurseHouse, CELADON_CURSE_HOUSE, $00
	map_attributes CeladonHotel1F, CELADON_HOTEL_1F, $00
	map_attributes CeladonHotelPool, CELADON_HOTEL_POOL, $00
	map_attributes EusinesHouse, EUSINES_HOUSE, $00
	map_attributes Route7UndergroundPathEntrance, ROUTE_7_UNDERGROUND_PATH_ENTRANCE, $00
	map_attributes RocketUndergroundTunnel, ROCKET_UNDERGROUND_TUNNEL, $bd
	map_attributes CeladonRocketHideoutB4F, CELADON_ROCKET_HIDEOUT_B4F, $00
	...
	map_attributes Route18EastWestGate, ROUTE_18_EAST_WEST_GATE, $00
	...
	map_attributes CianwoodBeastsHouse, CIANWOOD_BEASTS_HOUSE, $00
	map_attributes CianwoodMoveTutorHouse, CIANWOOD_MOVE_TUTOR_HOUSE, $00
	map_attributes CianwoodPhotoStudio, CIANWOOD_PHOTO_STUDIO, $00
	map_attributes BattleTower1F, BATTLE_TOWER_1F, $00
	map_attributes BattleTower2F, BATTLE_TOWER_2F, $00
	...
	map_attributes Route2ViridianForestGate, ROUTE_2_VIRIDIAN_FOREST_GATE, $00
	map_attributes ViridianForest, VIRIDIAN_FOREST, $4d
	map_attributes ViridianForestHouse, VIRIDIAN_FOREST_HOUSE, $00
	map_attributes ViridianForestRoute2Gate, VIRIDIAN_FOREST_ROUTE_2_GATE, $00
	map_attributes Route2Gate, ROUTE_2_GATE, $00
	map_attributes PokemonLeagueGate, POKEMON_LEAGUE_GATE, $00
	...
	map_attributes LyrasHouse1F, LYRAS_HOUSE_1F, $00
	map_attributes LyrasHouse2F, LYRAS_HOUSE_2F, $00
	...
	map_attributes Route27AerialAceHouse, ROUTE_27_AERIAL_ACE_HOUSE, $00
	...
	map_attributes SaffronAviculturalSociety1F, SAFFRON_AVICULTURAL_SOCIETY_1F, $00
	map_attributes SaffronAviculturalSociety2F, SAFFRON_AVICULTURAL_SOCIETY_2F, $00
	map_attributes SaffronAviculturalSociety3F, SAFFRON_AVICULTURAL_SOCIETY_3F, $00
	map_attributes SaffronOddishDollHouse, SAFFRON_ODDISH_DOLL_HOUSE, $00
	...
	map_attributes CherrygroveMoveTutorHouse, CHERRYGROVE_MOVE_TUTOR_HOUSE, $00
