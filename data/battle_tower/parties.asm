...
; BattleTowerMons group 1
	...
	db UMBREON
	db SITRUS_BERRY
	db SHADOW_BALL, IRON_TAIL, MUD_SLAP, TOXIC
	dw 0 ; OT ID
	bigdt 1000 ; Exp
	...
	db MISDREAVUS
	db FOCUS_BAND
	db DRAIN_KISS, MEAN_LOOK, PAIN_SPLIT, SHADOW_BALL
	dw 0 ; OT ID
	bigdt 1000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db UNOWN
	db ORAN_BERRY
	db HIDDEN_POWER, OMINOUS_WIND, 0, 0
	dw 0 ; OT ID
	bigdt 1000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 2
	...
	db ALAKAZAM
	db BERRY_JUICE
	db PSYCHIC_M, CALM_MIND, TOXIC, CHARGE_BEAM
	dw 0 ; OT ID
	bigdt 8000 ; Exp
	...
	db BLISSEY
	db BRIGHTPOWDER
	db PSYCHIC_M, DAZZLINGLEAM, FRESH_SNACK, COUNTER
	dw 0 ; OT ID
	bigdt 8000 ; Exp
	...
	db WIGGLYTUFF
	db PINK_BOW
	db PSYCHIC_M, SWAGGER, MUD_SLAP, HEADBUTT
	dw 0 ; OT ID
	bigdt 8000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 3
	...
	db POLIWRATH
	db BRIGHTPOWDER
	db DOUBLE_TEAM, SURF, WATER_PULSE, FOCUS_BLAST
	dw 0 ; OT ID
	bigdt 27000 ; Exp
	...
	db MAROWAK
	db THICK_CLUB
	db EARTHQUAKE, RETURN, HYPER_BEAM, BULLDOZE
	dw 0 ; OT ID
	bigdt 27000 ; Exp
...
; BattleTowerMons group 4
	...
	db PORYGON2
	db NO_ITEM
	db CHARGE_BEAM, CONVERSION, PSYBEAM, THIEF
	dw 0 ; OT ID
	bigdt 64000 ; Exp
	db 224, 213, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db EXEGGUTOR
	db BRIGHTPOWDER
	db ENERGY_BALL, STOMP, CALM_MIND, PSYCHIC_M
	dw 0 ; OT ID
	bigdt 64000 ; Exp
	db 224, 224, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 5
	...
	db SCIZOR
	db LEFTOVERS
	db GIGA_IMPACT, SLASH, AGILITY, METAL_CLAW
	dw 0 ; OT ID
	bigdt 125000 ; Exp
	db 213, 224, 200, 224, 213, 213 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db AERODACTYL
	db KINGS_ROCK
	db GIGA_IMPACT, EARTHQUAKE, ROCK_SLIDE, IRON_TAIL
	dw 0 ; OT ID
	bigdt 125000 ; Exp
	db 213, 224, 224, 213, 213, 213 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db CROBAT
	db LEFTOVERS
	db CONFUSE_RAY, WING_ATTACK, SLUDGE_BOMB, TOXIC
	dw 0 ; OT ID
	bigdt 125000 ; Exp
	...
	db GYARADOS
	db MUSCLE_BAND
	db GIGA_IMPACT, AQUA_TAIL, RAIN_DANCE, OUTRAGE
	dw 0 ; OT ID
	bigdt 125000 ; Exp
	db 200, 200, 200, 200, 200, 200 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db ARTICUNO
	db LIFE_ORB
	db ICE_BEAM, AERIAL_ACE, WATER_PULSE, SIGNAL_BEAM
	dw 0 ; OT ID
	bigdt 125000 ; Exp
	db 200, 200, 200, 200, 200, 200 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 6
	...
	db TYRANITAR
	db MUSCLE_BAND
	db CRUNCH, EARTHQUAKE, ROCK_SLIDE, GIGA_IMPACT
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	...
	db PORYGON2
	db LEFTOVERS
	db HYPER_BEAM, RECOVER, TOXIC, THUNDERBOLT
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	...
	db MACHAMP
	db LIFE_ORB
	db FIRE_PUNCH, DRAIN_PUNCH, THUNDERPUNCH, EARTHQUAKE
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	...
	db ZAPDOS
	db LIFE_ORB
	db HEAT_WAVE, AIR_SLASH, THUNDERBOLT, THUNDER_WAVE
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	db 224, 213, 224, 235, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db AERODACTYL
	db LEFTOVERS
	db GIGA_IMPACT, ROCK_SLIDE, EARTHQUAKE, IRON_BASH
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	db 213, 224, 224, 213, 213, 213 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db DRAGONITE
	db MUSCLE_BAND
	db GIGA_IMPACT, ICE_BEAM, THUNDERBOLT, OUTRAGE
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	db 213, 224, 200, 224, 213, 213 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db JYNX
	db LUM_BERRY
	db BLIZZARD, PSYCHIC_M, SHADOW_BALL, DRAIN_KISS
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	db 224, 224, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db BLASTOISE
	db SCOPE_LENS
	db AQUA_TAIL, IRON_BASH, RAPID_SPIN, BLIZZARD
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	db 224, 224, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db RHYDON
	db QUICK_CLAW
	db EARTHQUAKE, AQUA_TAIL, IRON_TAIL, ROCK_SLIDE
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	db 224, 224, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db SANDSLASH
	db SCOPE_LENS
	db EARTHQUAKE, SLASH, POISON_JAB, NIGHT_SLASH
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db PARASECT
	db LIFE_ORB
	db SPORE, GIGA_DRAIN, HEX, SLUDGE_BOMB
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db GOLEM
	db LIFE_ORB
	db EXPLOSION, EARTHQUAKE, FIRE_PUNCH, ROCK_TOMB
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 7
	...
	db UMBREON
	db SITRUS_BERRY
	db FEINT_ATTACK, HEALINGLIGHT, MUD_SLAP, TOXIC
	dw 0 ; OT ID
	bigdt 343000 ; Exp
	...
	db SNORLAX
	db LEFTOVERS
	db ROCK_SLIDE, EARTHQUAKE, ZEN_HEADBUTT, GROWTH_PUNCH
	dw 0 ; OT ID
	bigdt 343000 ; Exp
	...
	db HOUNDOOM
	db KINGS_ROCK
	db DARK_PULSE, FLAMETHROWER, SHADOW_BALL, NASTY_PLOT
	dw 0 ; OT ID
	bigdt 343000 ; Exp
	...
	db TYRANITAR
	db LEFTOVERS
	db EARTHQUAKE, CRUNCH, STONE_EDGE, GIGA_IMPACT
	dw 0 ; OT ID
	bigdt 343000 ; Exp
	...
	db GYARADOS
	db MUSCLE_BAND
	db AQUA_TAIL, CRUNCH, GIGA_IMPACT, BULLDOZE
	dw 0 ; OT ID
	bigdt 343000 ; Exp
	...
	db VENUSAUR
	db BRIGHTPOWDER
	db SUNNY_DAY, SOLARBEAM, HEALINGLIGHT, HYPER_BEAM
	dw 0 ; OT ID
	bigdt 343000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 8
	...
	db SNORLAX
	db LEFTOVERS
	db ZEN_HEADBUTT, BELLY_DRUM, GROWTH_PUNCH, EARTHQUAKE
	dw 0 ; OT ID
	bigdt 512000 ; Exp
	...
	db FORRETRESS
	db LEFTOVERS
	db IRON_BASH, TOXIC, EARTHQUAKE, SWAGGER
	dw 0 ; OT ID
	bigdt 512000 ; Exp
	...
	db DRAGONITE
	db SITRUS_BERRY
	db THUNDER_WAVE, AQUA_TAIL, THUNDERBOLT, OUTRAGE
	dw 0 ; OT ID
	bigdt 512000 ; Exp
	...
	db PORYGON2
	db LIFE_ORB
	db THUNDERBOLT, RECOVER, HYPER_BEAM, TRI_ATTACK
	dw 0 ; OT ID
	bigdt 512000 ; Exp
	db 235, 224, 200, 235, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db AERODACTYL
	db LUM_BERRY
	db HYPER_BEAM, REST, EARTHQUAKE, STONE_EDGE
	dw 0 ; OT ID
	bigdt 512000 ; Exp
	db 224, 200, 224, 200, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db PINSIR
	db LIFE_ORB
    db GIGA_IMPACT, X_SCISSOR, STRENGTH, TOXIC
	dw 0 ; OT ID
	bigdt 512000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db GRANBULL
	db BRIGHTPOWDER
	db DRAIN_PUNCH, SHADOW_BALL, GIGA_IMPACT, THUNDERPUNCH
	dw 0 ; OT ID
	bigdt 512000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 9
	...
	db UMBREON
	db LEFTOVERS
	db NIGHT_SLASH, MUD_SLAP, IRON_TAIL, CONFUSE_RAY
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	...
	db DRAGONITE
	db LIFE_ORB
	db FIRE_PUNCH, GIGA_IMPACT, OUTRAGE, STEEL_WING
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	...
	db STARMIE
	db LEFTOVERS
	db ICE_BEAM, THUNDERBOLT, SURF, PSYCHIC_M
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	...
	db CLOYSTER
	db LEFTOVERS
	db ICICLE_CRASH, POISON_JAB, SURF, BODY_SLAM
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	db 224, 224, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db CROBAT
	db SITRUS_BERRY
	db SLUDGE_BOMB, ACROBATICS, CONFUSE_RAY, X_SCISSOR
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	db 224, 224, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db PORYGON2
	db QUICK_CLAW
	db TOXIC, THUNDERBOLT, RECOVER, HYPER_BEAM
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	db 224, 213, 224, 235, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db TYRANITAR
	db QUICK_CLAW
	db GIGA_IMPACT, CRUNCH, EARTHQUAKE, STONE_EDGE
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	...
	db ESPEON
	db LIFE_ORB
	db PSYCHIC_M, SHADOW_BALL, DRAIN_KISS, CALM_MIND
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	...
	db MACHAMP
	db LIFE_ORB
	db CROSS_CHOP, DRAIN_PUNCH, STONE_EDGE, EARTHQUAKE
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	...
	db SNORLAX
	db LIFE_ORB
	db REST, SNORE, ZEN_HEADBUTT, BODY_SLAM
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	...
	db BLISSEY
	db LEFTOVERS
	db SOLARBEAM, SUNNY_DAY, FRESH_SNACK, FIRE_BLAST
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	db 224, 213, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db HOUNDOOM
	db BRIGHTPOWDER
	db FLAMETHROWER, DARK_PULSE, SUNNY_DAY, SOLARBEAM
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	db 224, 200, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db FLAREON
	db CHESTO_BERRY
	db FLAME_CHARGE, BODY_SLAM, MUD_SLAP, DOUBLE_TEAM
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	db 224, 224, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db TAUROS
	db LIFE_ORB
	db MEGAHORN, GIGA_IMPACT, OUTRAGE, EARTHQUAKE
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db MUK
	db QUICK_CLAW
	db TOXIC, GUNK_SHOT, DRAIN_PUNCH, FEINT_ATTACK
	dw 0 ; OT ID
	bigdt 729000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 10
	...
	db HOUNDOOM
	db CHESTO_BERRY
	db DARK_PULSE, FLAMETHROWER, NASTY_PLOT, REST
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
	...
	db MACHAMP
	db LIFE_ORB
	db DRAIN_PUNCH, EARTHQUAKE, STONE_EDGE, THIEF
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
	db 245, 245, 245, 245, 245, 245 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db KINGDRA
	db CHOICE_SPECS
	db SCALD, DRAGON_PULSE, ICE_BEAM, SLUDGE
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
	db 245, 245, 245, 245, 245, 245 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db JOLTEON
	db LUM_BERRY
	db THUNDERBOLT, HYPER_BEAM, SHADOW_BALL, MUD_SLAP
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
	db 224, 224, 224, 174, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db TAUROS
	db LIFE_ORB
	db GIGA_IMPACT, EARTHQUAKE, IRON_TAIL, ZEN_HEADBUTT
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
	db 224, 224, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db ARCANINE
	db LEFTOVERS
	db FLAME_CHARGE, EXTREMESPEED, IRON_TAIL, PLAY_ROUGH
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
	db 235, 224, 224, 235, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db CHARIZARD
	db SCOPE_LENS
	db FIRE_BLAST, HURRICANE, ANCIENTPOWER, DRAGON_PULSE
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
	...
	db RHYDON
	db MUSCLE_BAND
	db AQUA_TAIL, EARTHQUAKE, GIGA_IMPACT, STONE_EDGE
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
	...
	db STEELIX
	db LEFTOVERS
	db EARTHQUAKE, GIGA_IMPACT, IRON_BASH, STONE_EDGE
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
	...
	db FARFETCH_D
	db LEEK
	db AERIAL_ACE, SLASH, POISON_JAB, NIGHT_SLASH
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
	db 235, 224, 224, 235, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db SNEASEL
	db MUSCLE_BAND
	db NIGHT_SLASH, ICICLE_CRASH, X_SCISSOR, POISON_JAB
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
	...
	db SCIZOR
	db QUICK_CLAW
	db IRON_BASH, X_SCISSOR, SLASH, TOXIC
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
	db 224, 224, 224, 224, 213, 213 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db PILOSWINE
	db MUSCLE_BAND
	db STONE_EDGE, ICICLE_CRASH, GIGA_IMPACT, EARTHQUAKE
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
	db 224, 224, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db EXEGGUTOR
	db WISE_GLASSES
	db PSYCHIC_M, TOXIC, SLUDGE_BOMB, GIGA_DRAIN
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
	db 224, 224, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db GOLEM
	db MUSCLE_BAND
	db GROWTH_PUNCH, EARTHQUAKE, STONE_EDGE, FIRE_PUNCH
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db HITMONCHAN
	db MUSCLE_BAND
	db DRAIN_PUNCH, FIRE_PUNCH, THUNDERPUNCH, ICE_PUNCH
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db LANTURN
	db SCOPE_LENS
	db HYDRO_PUMP, RAIN_DANCE, ZAP_CANNON, SIGNAL_BEAM
	dw 0 ; OT ID
	bigdt 1000000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
