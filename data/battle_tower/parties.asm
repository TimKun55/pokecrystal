...
; BattleTowerMons group 1
	...
	db KANGASKHAN
	db LUM_BERRY
	db REVERSAL, GIGA_IMPACT, EARTHQUAKE, ATTRACT
	dw 0 ; OT ID
	dt 1000 ; Exp
	...
	db MILTANK
	db SITRUS_BERRY
	db BLIZZARD, EARTHQUAKE, GIGA_IMPACT, TOXIC
	dw 0 ; OT ID
	dt 1000 ; Exp
	...
	db AERODACTYL
	db LEFTOVERS
	db HYPER_BEAM, BITE, EARTHQUAKE, STONE_EDGE
	dw 0 ; OT ID
	dt 1000 ; Exp
	...
	db HOUNDOUR
	db SITRUS_BERRY
	db DARK_PULSE, SOLARBEAM, FLAMETHROWER, SUNNY_DAY
	dw 0 ; OT ID
	dt 1000 ; Exp
	...
	db SNORLAX
	db LUM_BERRY
	db GIGA_IMPACT, REST, SNORE, SURF
	dw 0 ; OT ID
	dt 1000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db EXEGGUTOR
	db BERRY_JUICE
	db TOXIC, GIGA_DRAIN, THIEF, PSYCHIC_M
	dw 0 ; OT ID
	dt 1000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db HERACROSS
	db SITRUS_BERRY
	db CROSS_CHOP, ENDURE, MEGAHORN, ROCK_SMASH
	dw 0 ; OT ID
	dt 1000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 4
	...
	db EXEGGUTOR
	db BRIGHTPOWDER
	db ENERGY_BALL, STOMP, PSYCH_UP, PSYCHIC_M
	dw 0 ; OT ID
	dt 64000 ; Exp
	db 224, 224, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 6
	...
	db UMBREON
	db SITRUS_BERRY
	db MUD_SLAP, HEALINGLIGHT, PSYCHIC_M, FAINT_ATTACK
	dw 0 ; OT ID
	dt 216000 ; Exp
	db 224, 224, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 7
	...
	db UMBREON
	db SITRUS_BERRY
	db FAINT_ATTACK, HEALINGLIGHT, PSYCH_UP, TOXIC
	dw 0 ; OT ID
	dt 343000 ; Exp
	...
	db UMBREON
	db SITRUS_BERRY
	db HEALINGLIGHT, FAINT_ATTACK, PSYCHIC_M, SHADOW_BALL
	dw 0 ; OT ID
	dt 343000 ; Exp
...
; BattleTowerMons group 8
	...
	db PINSIR
	db SITRUS_BERRY
	db HYPER_BEAM, FOCUS_BLAST, STRENGTH, TOXIC
	dw 0 ; OT ID
	dt 512000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 9
	...
	db UMBREON
	db KINGS_ROCK
	db FAINT_ATTACK, MUD_SLAP, HEALINGLIGHT, CONFUSE_RAY
	dw 0 ; OT ID
	dt 729000 ; Exp
