...
; entries correspond to ENGINE_* constants
	...
	engine_flag wMumSavingMoney, MUM_SAVING_SOME_MONEY_F
	engine_flag wMumSavingMoney, MUM_ACTIVE_F
	...
	engine_flag wUnlockedUnowns, UNLOCKED_UNOWNS_A_TO_G_F
	engine_flag wUnlockedUnowns, UNLOCKED_UNOWNS_H_TO_N_F
	engine_flag wUnlockedUnowns, UNLOCKED_UNOWNS_O_TO_U_F
	engine_flag wUnlockedUnowns, UNLOCKED_UNOWNS_V_TO_QUESTION_F
	...
	engine_flag wDailyFlags1, DAILYFLAGS1_INDIGO_PLATEAU_LYRA_FIGHT
...
; Overworld states that get reset daily
	...
	engine_flag wDailyFlags2, DAILYFLAGS2_DAILY_MOUNT_MOON_B2F_FOSSIL
	engine_flag wDailyFlags2, DAILYFLAGS2_DAILY_CIANWOOD_PHOTOGRAPH
