...
; entries correspond to NPCTRADE_* constants
	...
	npctrade TRADE_DIALOGSET_NEWBIE,    CHIKORITA,  CHARMANDER, "Lizzy@@@@@@", $c9, $9f, POMEG_BERRY,  00147, "Aizen@@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_NEWBIE,    CYNDAQUIL,  SQUIRTLE,   "Umigame@@@@", $79, $9f, POMEG_BERRY,  00147, "Aizen@@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_NEWBIE,    TOTODILE,   BULBASAUR,  "Berny@@@@@@", $9b, $bf, POMEG_BERRY,  00147, "Aizen@@@@@@", TRADE_GENDER_EITHER
	...
	npctrade TRADE_DIALOGSET_GIRL,      KINGLER,    KINGDRA,    "Kaiba@@@@@@", $79, $9f, SITRUS_BERRY, 00283, "Emy@@@@@@@@", TRADE_GENDER_EITHER
