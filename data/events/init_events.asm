InitialEvents:
	...
	setevent EVENT_TEAM_ROCKET_BASE_B2F_GRUNT_WITH_EXECUTIVE ; TEAM_ROCKET_BASE_B2F_GRUNT_WITH_ARIANA
	setevent EVENT_TEAM_ROCKET_BASE_B2F_EXECUTIVE ; TEAM_ROCKET_BASE_B2F_ARIANA
