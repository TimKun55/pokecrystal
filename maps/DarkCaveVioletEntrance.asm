...
DarkCaveVioletEntranceTMSlugde:
	itemball TM_SLUDGE
...
DarkCaveVioletEntrance_MapEvents:
	...
	object_event  9, 15, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_TM_BALL, OBJECTTYPE_ITEMBALL, 0, DarkCaveVioletEntranceTMSlugde, EVENT_DARK_CAVE_VIOLET_ENTRANCE_TM_SLUDGE
