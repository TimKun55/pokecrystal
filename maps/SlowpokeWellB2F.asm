...
SlowpokeWellB2F_MapEvents:
	...
	object_event 15,  5, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, SlowpokeWellB2FWaterStone, EVENT_SLOWPOKE_WELL_B2F_WATER_STONE
