...
RuinsOfAlphGSBallChamber_MapEvents:
	...
	def_object_events
	object_event  3,  8, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_KEY_ITEM, OBJECTTYPE_ITEMBALL, 0, RuinsOfAlphGSBallChamberBallRelic, EVENT_GS_BALL_CHAMBER_BALL_RELIC
