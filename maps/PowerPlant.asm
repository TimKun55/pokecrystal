...
.Continue:
	...
	waitsfx
	setmapscene CELADON_CITY, SCENE_CELADONCITY_DISGUISED
	end
...
PowerPlant_MapEvents:
	...
	warp_event  3, 17, ROUTE_10_NORTH, 4
	...
	object_event 17,  9, SPRITE_FAT_GUY, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, PowerPlantManager, -1
	object_event  5,  5, SPRITE_GYM_GUIDE, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Forest, -1
	object_event  1, 15, SPRITE_GIOVANNI, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, PowerPlantGiovanniScript, EVENT_ROCKETS_IN_KANTO
