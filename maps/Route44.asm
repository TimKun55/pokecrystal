...
Route44AspearTree:
	fruittree FRUITTREE_ROUTE_44_ASPEAR
...
Route44_MapEvents:
	...
	object_event 51, 14, SPRITE_LADY, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 1, TrainerLadyAya, -1
	...
	object_event  9,  5, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route44AspearTree, -1
