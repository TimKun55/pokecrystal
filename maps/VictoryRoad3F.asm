...
VictoryRoad3F_MapEvents:
	...
	object_event 16,  4, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_POKE_BALL, OBJECTTYPE_ITEMBALL, 0, VictoryRoad3FUltraBall, EVENT_VICTORY_ROAD_3F_ULTRA_BALL
	object_event  8, 10, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_POKE_BALL, OBJECTTYPE_ITEMBALL, 0, VictoryRoad3FBigNugget, EVENT_VICTORY_ROAD_3F_BIG_NUGGET
	object_event 23, 17, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_TM_ITEM, OBJECTTYPE_ITEMBALL, 0, VictoryRoad3FTMEarthquake, EVENT_VICTORY_ROAD_3F_TM_EARTHQUAKE
