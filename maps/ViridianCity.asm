...
ViridianCity_MapEvents:
	...
	def_warp_events
	warp_event 28,  9, VIRIDIAN_GYM, 1
	warp_event 21, 13, VIRIDIAN_NICKNAME_SPEECH_HOUSE, 1
	...
	bg_event 26,  9, BGEVENT_READ, ViridianGymSign
	...
	object_event 29, 11, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, ViridianCityGrampsNearGym, -1
