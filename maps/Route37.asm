...
Route37_MapEvents:
	...
	def_coord_events
	coord_event 16,  2, SCENE_ROUTE37_ENTEI1, Route37Entei1aScript
	coord_event 17,  3, SCENE_ROUTE37_ENTEI1, Route37Entei1bScript
	coord_event 16,  2, SCENE_ROUTE37_ENTEI2, Route37Entei2aScript
	coord_event 17,  3, SCENE_ROUTE37_ENTEI2, Route37Entei2bScript

	def_bg_events
	bg_event  7,  9, BGEVENT_READ, Route37Sign
	bg_event 10, 15, BGEVENT_ITEM, Route37HiddenEther
	...
	object_event 17, 13, SPRITE_BUG_MANIAC, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 1, TrainerBugManiacCarl, -1
	object_event 18,  8, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SunnyScript, EVENT_ROUTE_37_SUNNY_OF_SUNDAY
	object_event 17,  2, SPRITE_ENTEI, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_SAW_ENTEI_ON_ROUTE_37
	object_event 15,  5, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route37RedApricornTree, -1
	object_event 18,  5, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route37BluApricornTree, -1
	object_event 17,  7, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route37BlkApricornTree, -1
	object_event 12,  5, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_ITEMBALL, 0, Route37TMBulldoze, EVENT_ROUTE_37_TM_BULLDOZE
