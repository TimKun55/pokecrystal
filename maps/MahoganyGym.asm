...
MahoganyGym_MapEvents:
	...
	object_event  4,  3, SPRITE_PILOSWINE, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, MahoganyGymPiloswine, EVENT_MAHOGANY_GYM_PILOSWINE
	object_event  4,  3, SPRITE_MAMOSWINE, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, MahoganyGymMamoswine, EVENT_MAHOGANY_GYM_MAMOSWINE
