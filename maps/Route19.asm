...
Route19_MapEvents:
	...
	def_object_events
	object_event  9, 27, SPRITE_SWIMMER_GIRL, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 0, TrainerSwimmerfDawn, -1
	object_event 14, 40, SPRITE_SWIMMER_GIRL, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 4, TrainerSwimmerfJill, -1
	object_event  6, 46, SPRITE_SWIMMER_GUY, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerSwimmermHarold, -1
	object_event 13, 18, SPRITE_SWIMMER_GUY, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerSwimmermJerome, -1
	object_event  8, 27, SPRITE_SWIMMER_GUY, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 0, TrainerSwimmermTucker, -1
	object_event  4, 23, SPRITE_SWIMMER_GUY, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerSwimmermWalter, -1
	...
	object_event 10, 36, SPRITE_SURFING_PIKACHU, SPRITEMOVEDATA_SWIM_WANDER, 2, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 1, Route19SurfingPikachuScript, -1
