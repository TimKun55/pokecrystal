	...
	const ROUTE3POKECENTER1F_FIREBREATHER
...
Route3Pokecenter1F_MapScripts:
	...
	def_callbacks
	callback MAPCALLBACK_TILES, Route3Pokecenter1FNoDownStairsCallback

Route3Pokecenter1FNoDownStairsCallback:
...
Route3Pokecenter1FFirebreatherScript:
	jumptextfaceplayer Route3Pokecenter1FFirebreatherText

Route3Pokecenter1FCooltrainerMScript:
	jumptextfaceplayer Route3Pokecenter1FCooltrainerMText

Route3Pokecenter1FFirebreatherText:
	text "A #mon Center"
	line "near a cave?"
...
Route3Pokecenter1F_MapEvents:
	...
	object_event  2,  3, SPRITE_FIREBREATHER, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route3Pokecenter1FFirebreatherScript, -1
