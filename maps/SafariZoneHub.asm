...
SafariZoneHub_MapEvents:
	...
	def_object_events
	object_event 17, 14, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, SafariZoneHubNuggetScript, EVENT_SAFARI_ZONE_HUB_NUGGET
	object_event 10, 23, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, SafariZoneHubUltraBallScript, EVENT_SAFARI_ZONE_HUB_ULTRA_BALL
