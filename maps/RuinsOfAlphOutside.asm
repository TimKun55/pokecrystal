...
RuinsOfAlphOutside_MapEvents:
	...
	warp_event 10, 13, RUINS_OF_ALPH_CAVE_ENTRANCE, 1
	...
	def_object_events
	object_event  4, 20, SPRITE_SCHOOLBOY, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 1, TrainerPsychicNathan, -1
