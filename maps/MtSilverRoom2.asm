...
MtSilverRoom2_MapEvents:
	...
	def_object_events
	object_event 24, 10, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MtSilverRoom2Calcium, EVENT_MT_SILVER_ROOM_2_CALCIUM
	object_event 22, 24, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MtSilverRoom2UltraBall, EVENT_MT_SILVER_ROOM_2_ULTRA_BALL
	object_event  4, 20, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MtSilverRoom2PPUp, EVENT_MT_SILVER_ROOM_2_PP_UP
