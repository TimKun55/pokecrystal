...
MtSilverRoom2_MapEvents:
	...
	def_object_events
	object_event 24,  8, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MtSilverRoom2Calcium, EVENT_MT_SILVER_ROOM_2_CALCIUM
