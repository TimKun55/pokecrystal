...
Route23_MapEvents:
	...
	warp_event  7, 139, VICTORY_ROAD_GATE, 6
	warp_event  8,  41, VICTORY_ROAD,  1
	warp_event 10,  23, VICTORY_ROAD, 10
	...
	object_event 13, 107, SPRITE_MORTY, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, Route23Morty, EVENT_ROUTE_23_MORTY
	...
	object_event 12,  55, SPRITE_STEELIX, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, Route23Steelix, EVENT_ROUTE_23_JASMINE
