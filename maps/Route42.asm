...
Route42_MapEvents:
	...
	object_event  9, 13, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_ITEMBALL, 0, Route42TMFeintAttack, EVENT_ROUTE_42_TM_FEINT_ATTACK
