...
Route42TMFeintAttack:
	itemball TM_FEINT_ATTACK

Route42PnkApricornTree:
	fruittree FRUITTREE_ROUTE_42_PNK_APRICORN

Route42GrnApricornTree:
	fruittree FRUITTREE_ROUTE_42_GRN_APRICORN

Route42YlwApricornTree:
	fruittree FRUITTREE_ROUTE_42_YLW_APRICORN

Route42ChestoTree:
	fruittree FRUITTREE_ROUTE_42_CHESTO
...
Route42_MapEvents:
	...
	object_event 51,  9, SPRITE_HIKER, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, TrainerHikerBenjamin, -1
	...
	object_event 27, 16, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route42PnkApricornTree, -1
	object_event 28, 16, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route42GrnApricornTree, -1
	object_event 29, 16, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route42YlwApricornTree, -1
	object_event  5, 13, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route42ChestoTree, -1
	...
	object_event  9, 13, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_TM_BALL, OBJECTTYPE_ITEMBALL, 0, Route42TMFeintAttack, EVENT_ROUTE_42_TM_FEINT_ATTACK
	object_event 26, 16, SPRITE_SUICUNE, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_PURPLE, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_SAW_SUICUNE_ON_ROUTE_42
