...
DanceTheater_MapEvents:
	...
	def_warp_events
	warp_event  5, 13, ECRUTEAK_CITY, 7
	warp_event  6, 13, ECRUTEAK_CITY, 7
	...
	object_event  6,  8, SPRITE_RHYDON_WALKING, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_SILVER, OBJECTTYPE_SCRIPT, 0, DanceTheaterRhydon, -1
