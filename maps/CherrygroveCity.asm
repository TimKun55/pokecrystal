...
; --- TESTING ---
	...
	loadmem wPartyMon2Moves+2, FLASH
	loadmem wPartyMon2Moves+3, PSYCHIC_M

	loadmem wPartyMon3Moves+0, WATERFALL
	loadmem wPartyMon3Moves+1, SURF
	loadmem wPartyMon3Moves+2, WHIRLPOOL
	loadmem wPartyMon3Moves+3, STRENGTH
...
CherrygroveCity_MapEvents:
	...
	warp_event 23,  3, CHERRYGROVE_MOVE_TUTOR_HOUSE, 1
	...
	object_event 25, 13, SPRITE_MARY, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, CherrygroveTeacherScript, -1
	...
	object_event  9, 12, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, MysticWaterGuy, -1
