...
GoldenrodCity_MapEvents:
	...
	warp_event 33, 27, GOLDENROD_BIKE_SHOP, 1
	warp_event 27, 15, GOLDENROD_HAPPINESS_RATER, 1
	warp_event  5, 28, BILLS_FAMILYS_HOUSE, 1
	...
	bg_event 18, 15, BGEVENT_READ, GoldenrodCitySign
	bg_event 34, 28, BGEVENT_READ, GoldenrodCityBikeShopSign
	...
	bg_event 12, 28, BGEVENT_READ, GoldenrodCityUndergroundSignSouth
	...
	object_event 25, 17, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityYoungster1Script, EVENT_GOLDENROD_CITY_CIVILIANS
	...
	object_event 16, 15, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_WANDER, 1, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityCooltrainerF2Script, EVENT_GOLDENROD_CITY_CIVILIANS
	...
	object_event  7, 24, SPRITE_GRAMPS, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodCityGrampsScript, EVENT_GOLDENROD_CITY_CIVILIANS
