...
DarkCaveBlackthornEntranceFullHeal:
	itemball FULL_HEAL
...
DarkCaveBlackthornEntrance_MapEvents:
	...
	object_event  7, 22, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, DarkCaveBlackthornEntranceFullHeal, EVENT_DARK_CAVE_BLACKTHORN_ENTRANCE_FULL_HEAL
