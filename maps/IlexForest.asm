...
IlexForest_MapEvents:
	...
	object_event 19,  9, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, IlexForestTMChargeBeam, EVENT_ILEX_FOREST_TM_CHARGE_BEAM
