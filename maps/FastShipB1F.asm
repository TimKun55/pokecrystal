...
.AlreadyInformed:
	writetextend FastShipB1FOnDutySailorRefusedText
...
.NotFoundGirl:
	promptbutton
	writetextend FastShipB1FOnDutySailorSawLittleGirlText

.FirstTime:
	writetextend FastShipB1FOnDutySailorDirectionsText
...
FastShipB1F_MapEvents:
	...
	object_event 36,  7, SPRITE_JUGGLER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 1, TrainerJugglerFritz, EVENT_FAST_SHIP_PASSENGERS_FIRST_TRIP
	...
	object_event 17, 11, SPRITE_TEACHER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 3, TrainerTeacherShirley, EVENT_FAST_SHIP_PASSENGERS_WESTBOUND
