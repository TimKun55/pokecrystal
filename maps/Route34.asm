...
Route34_MapEvents:
	...
	bg_event  6, 34, BGEVENT_ITEM, Route34HiddenRareCandy
	...
	object_event 14, 18, SPRITE_DAY_CARE_MON_1, SPRITEMOVEDATA_POKEMON, 2, 2, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, DayCareMon1Script, EVENT_DAY_CARE_MON_1
