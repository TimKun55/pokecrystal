...
SafariZoneWest_MapEvents:
	...
	object_event 15, 19, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_TM_BALL, OBJECTTYPE_ITEMBALL, 0, SafariZoneWestTMBodySlam, EVENT_SAFARI_ZONE_WEST_TM_BODY_SLAM
