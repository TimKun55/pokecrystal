...
LakeOfRage_MapEvents:
	...
	object_event 31,  3, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_ITEMBALL, 0, LakeOfRageTMHeatWave, EVENT_LAKE_OF_RAGE_TM_HEAT_WAVE
