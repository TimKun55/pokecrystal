...
RocketBaseElectrodeScript:
	...
	setevent EVENT_MAHOGANY_TOWN_FISHER_BLOCKS_GYM
...
TeamRocketBaseB2F_MapEvents:
	...
	object_event  3, 10, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_TM_ITEM, OBJECTTYPE_ITEMBALL, 0, TeamRocketBaseB2FTMThief, EVENT_TEAM_ROCKET_BASE_B2F_TM_THIEF
