...
OlivineLighthouse3F_MapEvents:
	...
	def_warp_events
	warp_event  5,  3, OLIVINE_LIGHTHOUSE_4F, 1
	warp_event 13,  3, OLIVINE_LIGHTHOUSE_2F, 2
	...
	object_event  8,  2, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_POKE_BALL, OBJECTTYPE_ITEMBALL, 0, OlivineLighthouse3FEther, EVENT_OLIVINE_LIGHTHOUSE_3F_ETHER
