...
MountMortar1FOutside_MapEvents:
	...
	object_event 29,  8, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MountMortar1FOutsideTMRockTomb, EVENT_MOUNT_MORTAR_1F_OUTSIDE_TM_ROCK_TOMB
