...
MountMortar1FOutside_MapEvents:
	...
	object_event 29,  8, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_TM_BALL, OBJECTTYPE_ITEMBALL, 0, MountMortar1FOutsideTMRockTomb, EVENT_MOUNT_MORTAR_1F_OUTSIDE_TM_ROCK_TOMB
