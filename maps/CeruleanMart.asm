...
CeruleanMart_CooltrainerMText:
	...
	cont "the way to Ceru-"
	cont "lean's Cape."

	para "They want to see"
	line "how they stack"
	cont "up against other"
	cont "trainers."
	done
...
CeruleanMart_CooltrainerFText:
	...
	line "only person in"
	cont "town who can beat"
	cont "the trainers at"
...
CeruleanMart_MapEvents:
	...
	def_object_events
	object_event  5,  2, SPRITE_CLERK, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CeruleanMart_Clerk, -1
	object_event  3,  5, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, CeruleanMart_CooltrainerM, -1
	object_event  7,  6, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 2, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, CeruleanMart_CooltrainerF, -1
