...
Route5_MapEvents:
	...
	def_warp_events
	warp_event 19, 37, ROUTE_5_UNDERGROUND_PATH_ENTRANCE, 1
	warp_event 20, 37, ROUTE_5_UNDERGROUND_PATH_ENTRANCE, 2
	warp_event 13, 41, ROUTE_5_SAFFRON_GATE, 1
	warp_event 14, 41, ROUTE_5_SAFFRON_GATE, 2
	warp_event 13, 23, ROUTE_5_CLEANSE_TAG_HOUSE, 1
	...
	object_event 22, 22, SPRITE_SUPER_NERD, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 2, Route5SuperNerdJayScript, -1
	object_event 19, 38, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route5OfficerScript, EVENT_ROUTE_5_6_OFFICER_BLOCKS_UNDERGROUND_PATH
	object_event 20, 38, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route5OfficerScript, EVENT_ROUTE_5_6_OFFICER_BLOCKS_UNDERGROUND_PATH
