...
NewBarkTown_MapEvents:
	...
	object_event 16,  3, SPRITE_HOOTHOOT, SPRITEMOVEDATA_POKEMON, 0, 0, -1, MORN, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, NewBarkTownHoothootScript, EVENT_NEW_BARK_TOD_POKEMON
	object_event 16,  3, SPRITE_HOOTHOOT, SPRITEMOVEDATA_POKEMON, 0, 0, -1, NITE, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, NewBarkTownHoothootScript, EVENT_NEW_BARK_TOD_POKEMON
	object_event 15,  3, SPRITE_PIDGEY, SPRITEMOVEDATA_POKEMON, 0, 0, -1, DAY, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, NewBarkTownPidgeyScript, EVENT_NEW_BARK_TOD_POKEMON
	object_event 15,  3, SPRITE_PIDGEY, SPRITEMOVEDATA_POKEMON, 0, 0, -1, EVE, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, NewBarkTownPidgeyScript, EVENT_NEW_BARK_TOD_POKEMON
