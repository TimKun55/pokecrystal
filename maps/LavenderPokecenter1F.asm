...
LavenderPokecenter1FYoungsterScript:
	...
	writetextend LavenderPokecenter1FYoungsterText

.ReturnedMachinePart:
	writetextend LavenderPokecenter1FYoungsterText_ReturnedMachinePart
...
LavenderPokecenter1FGentlemanText:
	...
	para "Go through it to"
	line "get to the Power"
	cont "Plant."
	done
...
LavenderPokecenter1F_MapEvents:
	...
	warp_event  6,  7, LAVENDER_TOWN, 2
	warp_event  0,  7, POKECENTER_2F, 1
	warp_event 11,  7, LAVENDER_MART, 1
	...
	object_event 10,  3, SPRITE_GENTLEMAN, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, LavenderPokecenter1FGentlemanScript, -1
	object_event  2,  4, SPRITE_TEACHER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, LavenderPokecenter1FTeacherScript, -1
	object_event  4,  5, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 1, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, LavenderPokecenter1FYoungsterScript, -1
