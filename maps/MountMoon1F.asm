...
MountMoon1F_MapEvents:
	...
	object_event 16, 22, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_POKE_BALL, OBJECTTYPE_ITEMBALL, 0, MountMoon1FRareCandyScript, EVENT_MT_MOON_1F_RARE_CANDY
	object_event  3,  2, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_POKE_BALL, OBJECTTYPE_ITEMBALL, 0, MountMoon1FReviveScript, EVENT_MT_MOON_1F_REVIVE
	object_event  2, 20, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_POKE_BALL, OBJECTTYPE_ITEMBALL, 0, MountMoon1FCalcium, EVENT_MT_MOON_1F_CALCIUM
