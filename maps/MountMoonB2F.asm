...
MountMoonB2F_MapEvents:
	...
	object_event 22,  9, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_POKE_BALL, OBJECTTYPE_ITEMBALL, 0, MountMoonB2FFullRestoreScript, EVENT_MOUNT_MOON_B2F_FULL_RESTORE
	object_event 26, 17, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_POKE_BALL, OBJECTTYPE_ITEMBALL, 0, MountMoonB2FZincScript, EVENT_MOUNT_MOON_B2F_ZINC
	object_event 18, 27, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_POKE_BALL, OBJECTTYPE_ITEMBALL, 0, MountMoonB2FRareCandyScript, EVENT_MOUNT_MOON_B2F_RARE_CANDY
	object_event 11, 20, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_POKE_BALL, OBJECTTYPE_ITEMBALL, 0, MountMoonB2FMoonStoneScript, EVENT_MOUNT_MOON_B2F_MOON_STONE
