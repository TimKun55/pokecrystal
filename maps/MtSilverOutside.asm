...
MtSilverOutside_MapEvents:
	...
	def_object_events
	object_event 30,  9, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_POKE_BALL, OBJECTTYPE_ITEMBALL, 0, MtSilverOutsideBigNugget, EVENT_MT_SILVER_OUTSIDE_BIG_NUGGET
