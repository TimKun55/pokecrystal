...
MountMoonSquare_MapEvents:
	...
	def_warp_events
	warp_event 20,  5, MOUNT_MOON_B1F, 12
	warp_event 22, 11, MOUNT_MOON_B1F, 13
	...
	bg_event 17,  6, BGEVENT_READ, DontLitterSign
	...
	object_event  7,  6, SPRITE_CLEFAIRY_WALKING, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_MT_MOON_SQUARE_CLEFAIRY
