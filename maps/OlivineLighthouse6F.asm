...
OlivineLighthouse6F_MapEvents:
	...
	object_event 11,  6, SPRITE_SAILOR, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, MORN, 0, OBJECTTYPE_SCRIPT, 0, OlivineLighthouse6FWindowCleanerScript, EVENT_OLIVINE_LIGHTHOUSE_6F_VISITORS
	...
	object_event  7, 14, SPRITE_SAILOR, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, EVE, 0, OBJECTTYPE_SCRIPT, 0, OlivineLighthouse6FWindowCleanerScript, EVENT_OLIVINE_LIGHTHOUSE_6F_VISITORS
	object_event  5, 10, SPRITE_SAILOR, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, NITE, 0, OBJECTTYPE_SCRIPT, 0, OlivineLighthouse6FWindowCleanerScript, EVENT_OLIVINE_LIGHTHOUSE_6F_VISITORS
	...
	object_event 13, 17, SPRITE_FISHING_GURU, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, OlivineLighthouse6FFishingGuruScript, EVENT_OLIVINE_LIGHTHOUSE_6F_VISITORS
