...
CinnabarPokecenter1F_MapScripts:
	...
	def_callbacks
	callback MAPCALLBACK_TILES, CinnabarPokecenter1FNoDownStairsCallback

CinnabarPokecenter1FNoDownStairsCallback:
...
CinnabarPokecenter1F_MapEvents:
	...
	warp_event  6,  7, CINNABAR_ISLAND, 2
	...
	object_event  2,  3, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 2, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, CinnabarPokecenter1FCooltrainerFScript, -1
