...
UndergroundPath_MapEvents:
	...
	def_object_events
	object_event  4, 13, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_TM_BALL, OBJECTTYPE_ITEMBALL, 0, UndergroundPathTMCalmMind, EVENT_UNDERGROUND_PATH_TM_CALM_MIND