...
SeafoamIslandsB1F_MapEvents:
	...
	warp_event  5, 13, SEAFOAM_ISLANDS_B2F, 3
	warp_event 11, 11, SEAFOAM_ISLANDS_B2F, 4
	...
	def_object_events
	object_event 15,  3, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_POKE_BALL, OBJECTTYPE_ITEMBALL, 0, SeafoamIslandsB1FRareCandy, EVENT_SEAFOAM_ISLANDS_B1F_RARE_CANDY
	object_event 21,  5, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_POKE_BALL, OBJECTTYPE_ITEMBALL, 0, SeafoamIslandsB1FIceHeal, EVENT_SEAFOAM_ISLANDS_B1F_ICE_HEAL
