...
RocketUndergroundTunnel_MapEvents:
	...
	def_object_events
	object_event 19, 10, SPRITE_FAT_GUY, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_PURPLE, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_ROCKET_UNDERGROUND_TUNNEL_DISGUISED_PETREL
