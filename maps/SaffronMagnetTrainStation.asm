...
SaffronMagnetTrainStationOfficerApproachFromGoldenrodMovement:
	step UP
	step UP
	step LEFT
	turn_head RIGHT
...
SaffronMagnetTrainStationOfficerReturnToBoardingGateArriveMovement:
	step RIGHT
	step DOWN
	step DOWN
	step_end
...
SaffronMagnetTrainStation_MapEvents:
	...
	warp_event  9, 17, SAFFRON_CITY, 7
