...
;	special InitRoamMons
	...
	setmapscene ROUTE_38, SCENE_ROUTE38_RAIKOU
	clearevent EVENT_SAW_RAIKOU_ON_ROUTE_38
...
BurnedTowerB1FEntei:
	...
	setmapscene ROUTE_37, SCENE_ROUTE37_NOOP
	setevent EVENT_SAW_ENTEI_ON_ROUTE_30
	setmapscene ROUTE_30, SCENE_ROUTE30_NOOP
...
BurnedTowerB1F_MapEvents:
	...
	def_warp_events
	warp_event 10,  9, BURNED_TOWER_1F, 5
	...
	object_event 10,  4, SPRITE_SUICUNE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_PURPLE, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_BURNED_TOWER_B1F_BEASTS_1
	...
	object_event 16,  4, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_TM_ITEM, OBJECTTYPE_ITEMBALL, 0, BurnedTowerB1FTMEndure, EVENT_BURNED_TOWER_B1F_TM_ENDURE
	...
	object_event 10,  3, SPRITE_ENTEI, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, BurnedTowerB1FEntei, EVENT_BURNED_TOWER_B1F_ENTEI
