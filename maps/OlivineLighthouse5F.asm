...
OlivineLighthouse5F_MapEvents:
	...
	def_bg_events
	bg_event  7,  7, BGEVENT_ITEM, OlivineLighthouse5FHiddenHyperPotion
	...
	object_event 15, 13, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_ITEMBALL, 0, OlivineLighthouse5FTMSwagger, EVENT_OLIVINE_LIGHTHOUSE_5F_TM_SWAGGER
