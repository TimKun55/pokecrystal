...
MtSilverPeak_MapEvents:
	...
	object_event 25, 36, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_POKE_BALL, OBJECTTYPE_ITEMBALL, 0, MtSilverPeakMaxRevive, EVENT_MT_SILVER_PEAK_MAX_REVIVE
	object_event  7, 31, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_POKE_BALL, OBJECTTYPE_ITEMBALL, 0, MtSilverPeakMaxFullRestore, EVENT_MT_SILVER_PEAK_FULL_RESTORE
