...
OlivineLighthouse2F_MapEvents:
	...
	def_warp_events
	warp_event  7,  2, OLIVINE_LIGHTHOUSE_1F, 3
	warp_event 14,  2, OLIVINE_LIGHTHOUSE_3F, 2
	...
	def_object_events
	object_event 12, 10, SPRITE_SAILOR, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 3, TrainerSailorHuey, -1
	object_event  5,  7, SPRITE_GENTLEMAN, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 3, TrainerGentlemanAlfred, -1
