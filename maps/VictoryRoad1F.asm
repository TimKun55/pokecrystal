...
VictoryRoad1F_MapEvents:
	...
	object_event  8, 28, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_POKE_BALL, OBJECTTYPE_ITEMBALL, 0, VictoryRoad1FSuperPotion, EVENT_VICTORY_ROAD_1F_SUPER_POTION
	object_event 15, 19, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_POKE_BALL, OBJECTTYPE_ITEMBALL, 0, VictoryRoad1FFullHeal, EVENT_VICTORY_ROAD_1F_FULL_HEAL
	object_event 19, 10, SPRITE_BALL_BOOK_POKEDEX, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_POKE_BALL, OBJECTTYPE_ITEMBALL, 0, VictoryRoad1FMaxRevive, EVENT_VICTORY_ROAD_1F_MAX_REVIVE
