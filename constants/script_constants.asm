...
; FruitTreeItems indexes (see data/items/fruit_trees.asm)
	const_def 1
	const FRUITTREE_ROUTE_29_ORAN                         ; 01
	const FRUITTREE_ROUTE_30_ORAN                         ; 02
	const FRUITTREE_ROUTE_38_ORAN                         ; 03
	const FRUITTREE_ROUTE_46_ORAN                         ; 04
	const FRUITTREE_ROUTE_30_PECHA                        ; 05
	const FRUITTREE_ROUTE_33_PECHA                        ; 06
	const FRUITTREE_ROUTE_31_PERSIM                       ; 07
	const FRUITTREE_ROUTE_43_PERSIM                       ; 08
	const FRUITTREE_VIOLET_CITY_CHERI                     ; 09
	const FRUITTREE_ROUTE_46_CHERI                        ; 0a
	const FRUITTREE_ROUTE_35_LEPPA                        ; 0b
	const FRUITTREE_ROUTE_45_LEPPA                        ; 0c
	const FRUITTREE_ROUTE_36_RAWST                        ; 0d
	const FRUITTREE_ROUTE_26_RAWST                        ; 0e
	const FRUITTREE_ROUTE_39_CHESTO                       ; 0f
	const FRUITTREE_ROUTE_44_ASPEAR                       ; 10
	const FRUITTREE_BLACKTHORN_CITY_SITRUS                ; 11
	const FRUITTREE_ROUTE_37_RED_APRICORN                 ; 12
	const FRUITTREE_ROUTE_37_BLU_APRICORN                 ; 13
	const FRUITTREE_ROUTE_37_BLK_APRICORN                 ; 14
	const FRUITTREE_AZALEA_TOWN_WHT_APRICORN              ; 15
	const FRUITTREE_ROUTE_42_PNK_APRICORN                 ; 16
	const FRUITTREE_ROUTE_42_GRN_APRICORN                 ; 17
	const FRUITTREE_ROUTE_42_YLW_APRICORN                 ; 18
	const FRUITTREE_ROUTE_42_CHESTO                       ; 19
	const FRUITTREE_ROUTE_11_ORAN                         ; 1a
	const FRUITTREE_ROUTE_2_PECHA                         ; 1b
	const FRUITTREE_ROUTE_1_PERSIM                        ; 1c
	const FRUITTREE_ROUTE_8_CHERI                         ; 1d
	const FRUITTREE_PEWTER_CITY_RAWST                     ; 1e
	const FRUITTREE_PEWTER_CITY_CHESTO                    ; 1f
	const FRUITTREE_FUCHSIA_CITY_ASPEAR                   ; 20
	const FRUITTREE_GOLDENROD_FLOWER_SHOP_GARDEN_KELPSY   ; 21
	const FRUITTREE_GOLDENROD_FLOWER_SHOP_GARDEN_QUALOT   ; 22
	const FRUITTREE_GOLDENROD_FLOWER_SHOP_GARDEN_POMEG    ; 23
	const FRUITTREE_GOLDENROD_FLOWER_SHOP_GARDEN_HONDEW   ; 24
	const FRUITTREE_GOLDENROD_FLOWER_SHOP_GARDEN_GREPA    ; 25
	const FRUITTREE_GOLDENROD_FLOWER_SHOP_GARDEN_TAMATO   ; 26
	const FRUITTREE_ROUTE_11_KELPSY                       ; 27
	const FRUITTREE_ROUTE_6_QUALOT                        ; 28
	const FRUITTREE_ROUTE_7_POMEG                         ; 29
	const FRUITTREE_ROUTE_8_HONDEW                        ; 2a
	const FRUITTREE_CELADON_CITY_GREPA                    ; 2b
	const FRUITTREE_CELADON_CITY_TAMATO                   ; 2c
...
; PaintingPalettes indexes (see data/events/paintings/palettes.asm)
	...
	const AERODACTYL_FOSSIL_PAINTING
	const OMASTAR_FOSSIL_PAINTING
	const KABUTOPS_FOSSIL_PAINTING
	const CUBONE_ARMOR_PAINTING
	const METEORITE_PAINTING
