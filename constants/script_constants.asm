...
; FruitTreeItems indexes (see data/items/fruit_trees.asm)
	...
	const FRUITTREE_ROUTE_7_1       ; 27
	const FRUITTREE_ROUTE_7_2       ; 28
	const FRUITTREE_ROUTE_7_3       ; 29
	const FRUITTREE_ROUTE_7_4       ; 2a
	const FRUITTREE_ROUTE_7_5       ; 2b
	const FRUITTREE_ROUTE_7_6       ; 2c
