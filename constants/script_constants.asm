...
; FruitTreeItems indexes (see data/items/fruit_trees.asm)
	...
	const FRUITTREE_BLACKTHORN_CITY ; 11
	...
	const FRUITTREE_GOLDENROD_FLOWER_SHOP_GARDEN_1   ; 21
	const FRUITTREE_GOLDENROD_FLOWER_SHOP_GARDEN_2   ; 22
	const FRUITTREE_GOLDENROD_FLOWER_SHOP_GARDEN_3   ; 23
	const FRUITTREE_GOLDENROD_FLOWER_SHOP_GARDEN_4   ; 24
	const FRUITTREE_GOLDENROD_FLOWER_SHOP_GARDEN_5   ; 25
	const FRUITTREE_GOLDENROD_FLOWER_SHOP_GARDEN_6   ; 26
