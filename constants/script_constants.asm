...
; FruitTreeItems indexes (see data/items/fruit_trees.asm)
	...
	const FRUITTREE_VERMILION_CITY_1     ; 27
	const FRUITTREE_VERMILION_CITY_2     ; 28
	const FRUITTREE_VERMILION_CITY_3     ; 29
	const FRUITTREE_VERMILION_CITY_4     ; 2a
	const FRUITTREE_VERMILION_CITY_5     ; 2b
	const FRUITTREE_VERMILION_CITY_6     ; 2c
