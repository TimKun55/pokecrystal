...
; More Crystal-exclusive events in Johto
	...
	const_skip ; const EVENT_BATTLE_HALL_AFTER_BATTLE
	const EVENT_BATTLE_HALL_PICK_UP_INVER_PRIZE
	...
	const EVENT_BATTLE_HALL_PICK_UP_THORTON_PRIZE
	const EVENT_BATTLE_HALL_TYPELESS_MODE
	const EVENT_BATTLE_HALL_INVERSE_MODE
	const EVENT_BATTLE_HALL_FIRST_TIME_MAX_INVER_POINTS
	const EVENT_BATTLE_HALL_FIRST_TIME_MAX_THORTON_POINTS
...
; New to Crystal
	...
	const EVENT_BATTLE_HALL_1F_INVER
	const EVENT_BATTLE_HALL_BATTLE_ROOM_INVER
	...
	const EVENT_BATTLE_HALL_1F_THORTON
	const EVENT_BATTLE_HALL_BATTLE_ROOM_THORTON
	const EVENT_BATTLE_HALL_1F_SCIENTIST
