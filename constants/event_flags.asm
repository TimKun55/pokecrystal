...
; More Crystal-exclusive events in Johto
	...
	const_skip ; EVENT_BATTLE_HALL_PICK_UP_THORTON_PRIZE
	const_skip ; EVENT_BATTLE_HALL_TYPELESS_MODE
	const_skip ; EVENT_BATTLE_HALL_INVERSE_MODE
...
; New to Crystal
	...
	const EVENT_LEGENDARY_GUARDIANS_ACTIVE
	...
	const_skip ; EVENT_VERMILION_CITY_BATTLE_HALL_GRAMPS
	const_skip ; EVENT_BATTLE_HALL_1F_INVER
	...
	const_skip ; EVENT_BATTLE_HALL_1F_THORTON
