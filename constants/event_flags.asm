...
; More Crystal-exclusive events in Johto
	...
	const_skip ; EVENT_BATTLE_HALL_FIRST_TIME_MAX_THORTON_POINTS
...
; Johto people
	...
	const_skip ; EVENT_OLIVINE_MARKET_CLERK_1
	const_skip ; EVENT_OLIVINE_MARKET_CLERK_2
	const_skip ; EVENT_OLIVINE_MARKET_CLERK_3
