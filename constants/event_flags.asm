...
; Johto story events
	...
	const EVENT_TALKED_TO_MUM_AFTER_MYSTERY_EGG_QUEST
	...
	const EVENT_GOT_EGG_TICKET_FROM_RADIO_TOWER
	...
	const EVENT_GOT_TM37_AERIAL_ACE
	const EVENT_FIRST_TIME_BANKING_WITH_MUM
...
; Johto hidden items
	...
	const EVENT_MT_SILVER_ROOM_1_HIDDEN_DIRE_HIT
	const EVENT_MT_SILVER_ROOM_1_HIDDEN_ULTRA_BALL
	const EVENT_MT_SILVER_ROOM_2_HIDDEN_MAX_POTION
	...
	const EVENT_ROUTE_32_HIDDEN_SUN_STONE
	...
	const EVENT_MT_SILVER_OUTSIDE_HIDDEN_FULL_RESTORE
; Crystal-exclusive events in Johto
	...
	const EVENT_MARY_INTERVIEW_AFTER_CHAMPION
	const EVENT_MARY_INTERVIEW_AFTER_POWER_PLANT
	const EVENT_MARY_INTERVIEW_AFTER_GRAND_CHAMPION
	const EVENT_EARNED_FIRST_BATTLE_POINTS
	const EVENT_BATTLE_TOWER_2F_CLERK_1_HAS_ITEM
	const EVENT_BATTLE_TOWER_2F_CLERK_2_HAS_ITEM
	const EVENT_BATTLE_TOWER_2F_CLERK_3_HAS_ITEM
	const EVENT_BATTLE_TOWER_2F_CLERK_4_HAS_ITEM
	const EVENT_BATTLE_TOWER_2F_CLERK_5_HAS_ITEM
...
; Kanto story events
	...
	const EVENT_TALKED_TO_VERMILION_SAILOR
	const EVENT_GOT_DIPLOMA
	const EVENT_CINNABAR_SURFING_COMPETITION_OVER
	...
	const EVENT_UNDERGROUND_HIDDEN_ROOM
	const EVENT_BEAT_KANTO_LEADERS
	const EVENT_ROCKETS_IN_KANTO
; Kanto hidden items
	...
	const EVENT_ROUTE_25_HIDDEN_MAX_POTION
	...
	const EVENT_VICTORY_ROAD_1F_HIDDEN_MAX_POTION
	const EVENT_VICTORY_ROAD_1F_HIDDEN_FULL_HEAL
	const EVENT_VICTORY_ROAD_2F_HIDDEN_MAX_REVIVE
	const EVENT_VICTORY_ROAD_2F_HIDDEN_ULTRA_BALL
	const EVENT_VICTORY_ROAD_2F_HIDDEN_PP_UP
	const EVENT_VICTORY_ROAD_3F_HYPER_POTION
	const EVENT_VICTORY_ROAD_3F_ZINC
	...
	const EVENT_ENCOUNTERED_LEGENDARY_BIRDS
	const EVENT_GOT_TM_HEX
	const EVENT_SEAFOAM_ISLANDS_B1F_HIDDEN_ESCAPE_ROPE
	...
	const EVENT_MT_MOON_1F_HIDDEN_PEARL
	const EVENT_MT_MOON_1F_HIDDEN_BIG_NUGGET
	...
	const EVENT_UNCOVERED_STAIRCASE_IN_CERULEAN_EMPTY_HOUSE
	const EVENT_SILPH_CO_ELEVATOR_UP
	const EVENT_SILPH_CO_SCIENTIST_INTRO_TEXT
	const EVENT_SILPH_CO_PLAYER_RETURNING
; Unused: next 54 events
...
; More Johto story events
	...
	const EVENT_SHOWED_MAGNEMITE_TO_BILLS_GRANDPA
...
; More Crystal-exclusive events in Johto
	...
	const EVENT_GOT_OLD_SEA_MAP
	const EVENT_GOT_GS_BALL_FROM_GOLDENROD_POKEMON_CENTER
	const EVENT_FOUGHT_MEW
	const EVENT_BEAT_ROUTE_23_FALKNER
	const EVENT_BEAT_ROUTE_23_BUGSY
	const EVENT_BEAT_ROUTE_23_WHITNEY
	const EVENT_BEAT_ROUTE_23_MORTY
	const EVENT_BEAT_ROUTE_23_CHUCK
	const EVENT_BEAT_ROUTE_23_JASMINE
	const EVENT_BEAT_ROUTE_23_PRYCE
	const EVENT_BEAT_ROUTE_23_CLAIR
	...
	const EVENT_BEAT_INVER_FIRST_TIME ; EVENT_BATTLE_HALL_AFTER_BATTLE
	const EVENT_BEAT_THORTON_FIRST_TIME ; EVENT_BATTLE_HALL_PICK_UP_INVER_PRIZE
	...
	const EVENT_GUARDIAN_AGATHA_INTRO ; EVENT_BATTLE_HALL_PICK_UP_THORTON_PRIZE
	const EVENT_GUARDIAN_LORELEI_INTRO ; EVENT_BATTLE_HALL_TYPELESS_MODE
	const EVENT_GUARDIAN_BLAINE_INTRO ; EVENT_BATTLE_HALL_INVERSE_MODE
	const EVENT_ROUTE_7_UNDERGROUND_PATH_DOORS_OPEN ; EVENT_BATTLE_HALL_FIRST_TIME_MAX_INVER_POINTS
	const EVENT_WELCOMED_TO_POKE_CENTER
	const EVENT_FARAWAY_ISLAND_FIRST_TRIP
	const EVENT_READ_FARAWAY_ISLAND_SIGN
; Unused: next 157 events
...
; Bird Keeper
	...
	const EVENT_BEAT_BIRD_KEEPER_TEDDY
	const EVENT_BEAT_BIRD_KEEPER_FRED
; Boarder
...
; Biker
	...
	const EVENT_BEAT_BIKER_ORVILLE
	const EVENT_BEAT_BIKER_BERT
	const EVENT_BEAT_BIKER_MANNY
; Psychic
...
; Juggler
	...
	const EVENT_BEAT_JUGGLER_NEDD
	const EVENT_BEAT_JUGGLER_ANGUS
	const_skip ; unused
; Gentleman
...
; Kimono Girl
	...
	const EVENT_BEAT_KIMONO_GIRL_SAKURA	
; Pokemaniac
	...
	const EVENT_BEAT_POKEMANIAC_TRAVIS
...
; Lass
	...
	const EVENT_BEAT_LASS_MAI
	const EVENT_BEAT_LASS_VERITY
; Hiker
	...
	const EVENT_BEAT_HIKER_DAN
	const EVENT_BEAT_HIKER_MICKY
; Bug Catcher
...
; Lady	
	const EVENT_BEAT_LADY_SUE
	const EVENT_BEAT_LADY_BEA
	const EVENT_BEAT_LADY_MIA
	const EVENT_BEAT_SUE_BEA_MIA
	const EVENT_BEAT_LADY_KAT
	const EVENT_BEAT_LADY_ADA
	const EVENT_BEAT_LADY_MAE
	const EVENT_BEAT_KAT_ADA_MAE
	const EVENT_BEAT_LADY_KAI
	const EVENT_BEAT_LADY_AYA
	const EVENT_BEAT_LADY_GIA
	const EVENT_BEAT_KAI_AYA_GIA
	const EVENT_BEAT_LADY_LIA
	const EVENT_BEAT_LADY_ZOE
	const EVENT_BEAT_LADY_EVA
	const EVENT_BEAT_LIA_ZOE_EVA
; Petrel
	const EVENT_BEAT_PETREL_1
	const EVENT_BEAT_PETREL_2
	const EVENT_BEAT_PETREL_3
; Proton
	const EVENT_BEAT_PROTON_1
	const EVENT_BEAT_PROTON_2
	const EVENT_BEAT_PROTON_3
; Bug Maniac
	const EVENT_BEAT_BUG_MANIAC_XANDER
	const EVENT_BEAT_BUG_MANIAC_BOBBY
	const EVENT_BEAT_BUG_MANIAC_CARL
	const EVENT_BEAT_BUG_MANIAC_PETE
	const EVENT_BEAT_BUG_MANIAC_KEIRAN
	const EVENT_BEAT_BUG_MANIAC_NEVILLE
	const EVENT_BEAT_BUG_MANIAC_ELI
	const EVENT_BEAT_BUG_MANIAC_MATT
	const EVENT_BEAT_BUG_MANIAC_TOBI
	const EVENT_BEAT_BUG_MANIAC_VAN
; Guardians
	const EVENT_BEAT_GUARDIAN_BLAINE
	const EVENT_BEAT_GUARDIAN_LORELEI
...
; Johto itemballs
	...
	const EVENT_LAKE_OF_RAGE_TM_HEAT_WAVE
	...
	const EVENT_SLOWPOKE_WELL_B2F_WATER_STONE
	...
	const EVENT_ICE_PATH_1F_FULL_RESTORE
	...
	const EVENT_MT_SILVER_ROOM_1_MAX_ELIXER
	const EVENT_MT_SILVER_ROOM_1_PROTEIN
	const EVENT_MT_SILVER_ROOM_1_ESCAPE_ROPE
	const EVENT_MT_SILVER_ITEM_ROOMS_MAX_REVIVE
	const EVENT_MT_SILVER_ITEM_ROOMS_FULL_RESTORE
	...
	const EVENT_DARK_CAVE_BLACKTHORN_ENTRANCE_FULL_RESTORE
...
; Johto people
	...
	const EVENT_PLAYERS_HOUSE_MUM_1
	const EVENT_PLAYERS_HOUSE_MUM_2
	...
	const EVENT_MOUNT_MORTAR_1F_OUTSIDE_TM_ROCK_TOMB
	...
	const EVENT_FAST_SHIP_B1F_SAILOR_BLOCKING
	const EVENT_FAST_SHIP_B1F_SAILOR_GENERATOR_ROOM
	...
	const EVENT_MAHOGANY_TOWN_HIKER_BLOCKS_EAST
	const EVENT_MAHOGANY_TOWN_FISHER_BLOCKS_GYM
	...
	const EVENT_REPENTING_ROCKETS
	const EVENT_VIOLET_GYM_HOOTHOOT
	const EVENT_VIOLET_GYM_NOCTOWL
	const EVENT_MAHOGANY_GYM_PILOSWINE
	const EVENT_MAHOGANY_GYM_MAMOSWINE
	...
	const EVENT_BUTTON_1_IN_CIANWOOD_GYM
	...
	const EVENT_SAW_RAIKOU_ON_ROUTE_38
	const EVENT_SAW_RAIKOU_ON_ROUTE_44
	const EVENT_SAW_RAIKOU_ON_ROUTE_43
	const EVENT_LAKE_OF_RAGE_RAIKOU
	const EVENT_SAW_ENTEI_ON_ROUTE_37
	const EVENT_SAW_ENTEI_ON_ROUTE_30
	const EVENT_BURNED_TOWER_B1F_ENTEI
	const EVENT_RUINS_OF_ALPH_OUTSIDE_FOSSIL_SCIENTIST
	const EVENT_RUINS_OF_ALPH_RESEARCH_CENTER_FOSSIL_SCIENTIST
	const EVENT_WHIRL_ISLAND_SE_TM_SCALD ; EVENT_OLIVINE_MARKET_CLERK_1
	const EVENT_ROUTE_42_TM_FEINT_ATTACK ; EVENT_OLIVINE_MARKET_CLERK_2
	const EVENT_UNDERGROUND_PATH_TM_CALM_MIND ; EVENT_OLIVINE_MARKET_CLERK_3
	const EVENT_BUTTON_2_IN_CIANWOOD_GYM
	const EVENT_ROUTE_24_TM_PROTECT ; EVENT_OLIVINE_MARKET_CUSTOMERS
	const EVENT_PLAYERS_HOUSE_1F_SILVER_TROPHY
	const EVENT_PLAYERS_HOUSE_1F_GOLD_TROPHY
	const EVENT_PLAYERS_HOUSE_1F_CRYSTAL_TROPHY
	const EVENT_ICE_PATH_1F_LANCE
	const EVENT_MT_SILVER_PEAK_MAX_REVIVE
	...
	const EVENT_ROUTE_37_TM_BULLDOZE
	const EVENT_SLOWPOKE_WELL_ENTRANCE_TM_MEGA_DRAIN
	const EVENT_DARK_CAVE_VIOLET_ENTRANCE_TM_SLUDGE
...
; Kanto people
	...
	const EVENT_ROUTE_5_6_OFFICER_BLOCKS_UNDERGROUND_PATH
...
; Kanto itemballs
	...
	const EVENT_ROCK_TUNNEL_1F_RARE_CANDY
	...
	const EVENT_VICTORY_ROAD_1F_SUPER_POTION
	...
	const EVENT_VICTORY_ROAD_2F_RARE_CANDY
	const EVENT_VICTORY_ROAD_3F_ULTRA_BALL
	const EVENT_VICTORY_ROAD_3F_BIG_NUGGET
	const EVENT_VICTORY_ROAD_3F_TM_EARTHQUAKE
...
; New to Crystal
	...
	const EVENT_RUINS_OF_ALPH_OUTSIDE_TOURIST_HIKER
	...
	const EVENT_ILEX_FOREST_TM_CHARGE_BEAM
	...
	const EVENT_MT_SILVER_ROOM_1_ULTRA_BALL
	const EVENT_MT_SILVER_ROOM_2_CALCIUM
	const EVENT_MT_SILVER_ROOM_2_ULTRA_BALL
	const EVENT_MT_SILVER_ROOM_2_PP_UP
	...
	const EVENT_SAFARI_ZONE_NORTH_WIDE_LENS
	const EVENT_SAFARI_ZONE_WEST_MAX_REVIVE
	const EVENT_SAFARI_ZONE_WEST_PP_UP
	const EVENT_SAFARI_ZONE_WEST_TM_BODY_SLAM
	const EVENT_MT_SILVER_OUTSIDE_BIG_NUGGET
	const EVENT_MOLTRES_NEST_MOLTRES
	const EVENT_ZAPDOS_NEST_ZAPDOS
	const EVENT_ARTICUNO_NEST_ARTICUNO
	const EVENT_FARAWAY_ISLAND_MEW
	const EVENT_CERULEAN_CAVE_B1F_MEWTWO
	const EVENT_KANTO_ROCKET_DISBAND
	const EVENT_ZAPDOS_NEST_AGATHA
	const EVENT_APPEARING_POKEMON
	const EVENT_ROUTE_23_FALKNER
	const EVENT_ROUTE_23_BUGSY
	const EVENT_ROUTE_23_WHITNEY
	const EVENT_ROUTE_23_MORTY
	const EVENT_ROUTE_23_CHUCK
	const EVENT_ROUTE_23_JASMINE
	const EVENT_ROUTE_23_PRYCE
	const EVENT_ROUTE_23_CLAIR
	const EVENT_SEAFOAM_ISLANDS_B1F_RARE_CANDY
	...
	const EVENT_SEAFOAM_ISLANDS_B4F_ZINC
	const EVENT_CINNABAR_VOLCANO_1F_OFFICER
	const EVENT_MT_MOON_1F_RARE_CANDY
	const EVENT_MT_MOON_1F_REVIVE
	const EVENT_MT_MOON_1F_CALCIUM
	const EVENT_MOUNT_MOON_B2F_FULL_RESTORE
	...
	const EVENT_OAK_IN_LAB
	const EVENT_TRAINER_HALL_CAL
	const EVENT_TRAINER_HALL_AGATHA
	const EVENT_TRAINER_HALL_LORELEI
	const EVENT_TRAINER_HALL_OAK
	const EVENT_SEAFOAM_GYM_MAGMAR
	const EVENT_SEAFOAM_GYM_MAGMORTAR
	...
	const EVENT_SEAFOAM_ISLANDS_B4F_LORELEI ; EVENT_VERMILION_CITY_BATTLE_HALL_GRAMPS
	const EVENT_LORELEI_LAPRAS ; EVENT_BATTLE_HALL_1F_INVER
	const EVENT_TRAINER_HALL_INVER
	const EVENT_REDS_HOUSE_2F_TROPHY
	const EVENT_REDS_HOUSE_1F_REDS_MUM
	const EVENT_VERMILION_SAILORS_HOUSE_SAILOR
	const EVENT_FUCHSIA_CINNABAR_HOUSE1_SAILOR
	const EVENT_CINNABAR_MOLTRES_NEST_BLAINE ; EVENT_BATTLE_HALL_1F_THORTON
	const EVENT_TRAINER_HALL_THORTON
	const EVENT_TRAINER_HALL_1F_SCIENTIST
	const EVENT_VERMILION_SAILORS_HOUSE_SCIENTIST
	const EVENT_FARAWAY_ISLAND_SCIENTIST
	const EVENT_FARAWAY_ISLAND_OUTSIDE_MEW
	const EVENT_ROUTE_4_FULL_RESTORE
	const EVENT_ROUTE_10_NORTH_HIKER_CUT_TREE
	const EVENT_ROUTE_10_NORTH_HIKER_CUTTING_TREE
	const EVENT_ROCKET_UNDERGROUND_TUNNEL_DISGUISED_PETREL
	const EVENT_KANTO_GIOVANNI
