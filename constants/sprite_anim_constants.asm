...
; SpriteAnimObjects indexes (see data/sprite_anims/objects.asm)
	...
	const SPRITE_ANIM_OBJ_SLOTS_COVER               ; 31
...
; SpriteAnimFrameData indexes (see data/sprite_anims/framesets.asm)
	...
	const SPRITE_ANIM_FRAMESET_SLOTS_COVER_WHITE         ; 47
	const SPRITE_ANIM_FRAMESET_SLOTS_COVER_GREEN         ; 48
...
; SpriteAnimOAMData indexes (see data/sprite_anims/oam.asm)
	...
	const SPRITE_ANIM_OAMSET_SLOTS_COVER_WHITE           ; 92
	const SPRITE_ANIM_OAMSET_SLOTS_COVER_GREEN           ; 93
