...
; DecorationIDs indexes (see data/decorations/decorations.asm)
	...
	const DECOFLAG_CHIKORITA_DOLL
	const DECOFLAG_CYNDAQUIL_DOLL
	const DECOFLAG_TOTODILE_DOLL
	const DECOFLAG_MAREEP_DOLL
	const DECOFLAG_TEDDIURSA_DOLL
	const DECOFLAG_EEVEE_DOLL
	const DECOFLAG_RAICHU_DOLL
...
DEF NUM_NON_TROPHY_DECOS EQU const_value
	...
	const DECOFLAG_CRYSTAL_TROPHY_DOLL
