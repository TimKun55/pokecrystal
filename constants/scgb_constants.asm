...
; SGBLayoutJumptable indexes (see engine/gfx/sgb_layouts.asm)
	...
	const SCGB_SUMMARY_SCREEN_HP_PALS
	const SCGB_POKEDEX
	...
	const SCGB_INTRO_GENDER_PALS
	const SCGB_NAMING_SCREEN
	const SCGB_BUY_MENU
	const SCGB_PLAIN
	const SCGB_EGG_SUMMARY_SCREEN
	const SCGB_MUSIC_PLAYER
...
; GetPredefPal arguments (see engine/gfx/color.asm)
	...
	const PREDEFPAL_MT_SILVER
	const PREDEFPAL_DUNGEONS
	const PREDEFPAL_SAFARI
	const PREDEFPAL_BATTLE_TOWER
	...
	const PREDEFPAL_POKEDEX_BLUE
	const PREDEFPAL_POKEDEX_BROWN
	const PREDEFPAL_GS_INTRO_GAMEFREAK_LOGO
	const PREDEFPAL_POKEDEX_GRAY
	const PREDEFPAL_PACK
