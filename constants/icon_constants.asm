...
; IconPointers indexes
	...
	const ICON_RHYPERIOR   ; RHYPERIOR
	const ICON_TANGROWTH   ; TANGROWTH
	const ICON_ELECTIVIRE  ; ELECTIVIRE
	const ICON_MAGMORTAR   ; MAGMORTAR
	...
	const ICON_PORYGON_Z   ; PORYGON_Z
