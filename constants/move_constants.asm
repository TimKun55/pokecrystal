...
; - BattleAnimations (see data/moves/animations.asm)
	const_def
	const NO_MOVE      ; 00
	const ENERGY_BALL  ; 01
	const KARATE_CHOP  ; 02
	const DOUBLESLAP   ; 03
	const DRAIN_PUNCH  ; 04
	const MEGA_PUNCH   ; 05
	const PAY_DAY      ; 06
	const FIRE_PUNCH   ; 07
	const ICE_PUNCH    ; 08
	...
	const SCRATCH      ; 0a
	const DARK_PULSE   ; 0b
	const FLAME_CHARGE ; 0c
	const DAZZLINGLEAM ; 0d
	...
	const AERIAL_ACE   ; 12
	const FLY          ; 13
	const OMINOUS_WIND ; 14
	const SLAM         ; 15
	const VINE_WHIP    ; 16
	const STOMP        ; 17
	const DOUBLE_KICK  ; 18
	const MEGA_KICK    ; 19
	const SILVER_WIND  ; 1a
	const GROWTH_PUNCH ; 1b
	const SAND_ATTACK  ; 1c
	const HEADBUTT     ; 1d
	const HORN_ATTACK  ; 1e
	const FURY_STRIKES ; 1f
	const WATER_PULSE  ; 20
	const TACKLE       ; 21
	const BODY_SLAM    ; 22
	const WRAP         ; 23
	const TAKE_DOWN    ; 24
	const THRASH       ; 25
	const GIGA_IMPACT  ; 26
	const TAIL_WHIP    ; 27
	const POISON_STING ; 28
	const SIGNAL_BEAM  ; 29
