...
; wUnlockedUnowns
	...
	const ENGINE_UNLOCKED_UNOWNS_V_TO_QUESTION
...
; wVisitedSpawns
	...
	const ENGINE_FLYPOINT_MT_SILVER
...
; Trainer rematch flags
	const ENGINE_DAILY_KIMONO_GIRL_SAKURA_REMATCH
; wDailyFlags2
	...
	const ENGINE_DAILY_MOUNT_MOON_B2F_FOSSIL
	const ENGINE_DAILY_CIANWOOD_PHOTOGRAPH
; wSwarmFlags
