...
PikachuPIcon::   INCBIN "gfx/icons/pikachu_p.2bpp"
...
UnownExclamationIcon::     INCBIN "gfx/icons/unown_exclamation.2bpp"
UnownQuestionIcon::     INCBIN "gfx/icons/unown_question.2bpp"